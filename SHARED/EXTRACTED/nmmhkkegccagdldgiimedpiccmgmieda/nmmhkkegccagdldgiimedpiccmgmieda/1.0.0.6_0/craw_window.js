...
k.makeIterator = function (a) {
    var c = "undefined" != typeof Symbol && Symbol.iterator && a[Symbol
        .iterator];
...
k.objectCreate = k.ASSUME_ES5 || "function" == typeof Object.create ? Object
    .create : function (a) {
        var c = function () {};
        c.prototype = a;
        return new c
    };
k.defineProperty = k.ASSUME_ES5 || "function" == typeof Object
    .defineProperties ? Object.defineProperty : function (a, c, d) {
...
k.IS_SYMBOL_NATIVE = "function" === typeof Symbol && "symbol" === typeof Symbol(
    "x");
...
k.polyfill = function (a, c, d) {
    c && (k.ISOLATE_POLYFILLS ? k.polyfillIsolated(a, c, d) : k
        .polyfillUnisolated(a, c))
};
k.polyfillUnisolated = function (a, c) {
    ...
    e = d[a];
    c = c(e);
    c != e && null != c && k.defineProperty(d, a, {
        configurable: !0,
        writable: !0,
        value: c
    })
...
k.polyfillIsolated = function (a, c, d) {
    ...
    c = c(d);
    null != c && (a ? k.defineProperty(k.polyfills, e, {
        configurable: !0,
        writable: !0,
        value: c
    }) : c !== d && (void 0 === k.propertyToPolyfillSymbol[e] && (k
            .propertyToPolyfillSymbol[e] = k.IS_SYMBOL_NATIVE ? k
            .global.Symbol(e) : k.POLYFILL_PREFIX + e), k
        .defineProperty(f, k.propertyToPolyfillSymbol[e], {
            configurable: !0,
            writable: !0,
            value: c
        })))
...
k.getConstructImplementation = function () {
    ...
    if (k.TRUST_ES6_POLYFILLS && "undefined" != typeof Reflect && Reflect
        .construct) {
...
k.construct = {
    valueOf: k.getConstructImplementation
}.valueOf();
...
k.setPrototypeOf = k.TRUST_ES6_POLYFILLS && "function" == typeof Object
    .setPrototypeOf ? Object.setPrototypeOf : k.underscoreProtoCanBeSet() ?
    function (a, c) {
        a.__proto__ = c;
...
k.polyfill("Reflect", function (a) {
    return a ? a : {}
}, "es6");
k.polyfill("Reflect.construct", function () {
    return k.construct
}, "es6");
k.polyfill("Reflect.setPrototypeOf", function (a) {
    if (a) return a;
    if (k.setPrototypeOf) {
...
k.checkStringArgs = function (a, c, d) {
    if (null == a) throw new TypeError(
        "The 'this' value for String.prototype." + d +
        " must not be null or undefined");
    if (c instanceof RegExp) throw new TypeError(
        "First argument to String.prototype." + d +
...
k.polyfill("String.prototype.repeat", function (a) {
    return a ? a : function (c) {
        var d = k.checkStringArgs(this, null, "repeat");
        if (0 > c || 1342177279 < c) throw new RangeError(
            "Invalid count value");
        c |= 0;
        for (var e = ""; c;)
            if (c & 1 && (e += d), c >>>= 1) d += d;
...
k.polyfill("String.prototype.trimLeft", function (a) {
    function c() {
...
k.polyfill("Symbol.iterator", function (a) {
    if (a) return a;
    a = Symbol("Symbol.iterator");
    for (var c =
            "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array"
            .split(" "), d = 0; d < c.length; d++) {
        var e = k.global[c[d]];
        "function" === typeof e && "function" != typeof e.prototype[
            a] && k.defineProperty(e.prototype, a, {
                configurable: !0,
                writable: !0,
                value: function () {
                    return k.iteratorPrototype(k
...
k.polyfill("Array.prototype.entries", function (a) {
    return a ? a : function () {
...
m.exportPath_ = function (a, c, d, e) {
    a = a.split(".");
    e = e || m.global;
    a[0] in e || "undefined" == typeof e.execScript || e.execScript("var " +
        a[0]);
    for (var f; a.length && (f = a.shift());)
        if (a.length || void 0 === c) e = e[f] && e[f] !== Object.prototype[
            f] ? e[f] : e[f] = {};
...
m.provide = function (a) {
    if (m.isInModuleLoader_()) throw Error(
...
m.getScriptNonce = function (a) {
    ...
    null === m.cspNonce_ && (m.cspNonce_ = m.getScriptNonce_(m.global
        .document));
    return m.cspNonce_
};
...
m.getScriptNonce_ = function (a) {
    return (a = a.querySelector && a.querySelector("script[nonce]")) && (a =
            a.nonce || a.getAttribute("nonce")) && m.NONCE_PATTERN_.test(
        a) ? a : ""
};
...
m.module = function (a) {
    ...
    if (!m.isInGoogModuleLoader_()) throw Error("Module " + a +
    ...
    if (m.moduleLoaderState_.moduleName) throw Error(
...
m.isInGoogModuleLoader_ = function () {
    return !!m.moduleLoaderState_ && m.moduleLoaderState_.type == m
        .ModuleType.GOOG
};
m.isInEs6ModuleLoader_ = function () {
    if (m.moduleLoaderState_ && m.moduleLoaderState_.type == m.ModuleType
        .ES6) return !0;
...
m.declareModuleId = function (a) {
    if (m.moduleLoaderState_) m.moduleLoaderState_.moduleName = a;
        ...
        if (!c || "function" != typeof c.getCurrentModulePath) throw Error(
            'Module with namespace "' + a +
            '" has been loaded incorrectly.');
        c = c.require(c.getCurrentModulePath());
        m.loadedModules_[a] = {
            exports: c,
            type: m.ModuleType.ES6,
            moduleId: a
        }
    }
};
m.setTestOnly = function (a) {
    if (m.DISALLOW_TEST_ONLY_CODE) throw a = a || "", Error(
...
m.addSingletonGetter = function (a) {
    ...
    a.getInstance = function () {
        ...
        m.DEBUG && (m.instantiatedSingletons_[m.instantiatedSingletons_
            .length] = a);
...
m.loadModule = function (a) {
    ...
    try {
        ...
        else if ("string" === typeof a) e = m.loadModuleFromSource_.call(
            void 0, e, a);
        else throw Error("Invalid module definition");
        var f = m.moduleLoaderState_.moduleName;
        if ("string" === typeof f && f) m.moduleLoaderState_
            .declareLegacyNamespace ? m.constructNamespace_(f, e, d !== e) :
            m.SEAL_MODULE_EXPORTS && Object.seal && "object" ==
            typeof e && null != e && Object.seal(e), m.loadedModules_[f] = {
                exports: e,
                type: m.ModuleType.GOOG,
...
m.normalizePath_ = function (a) {
    a = a.split("/");
    for (var c = 0; c < a.length;) "." == a[c] ? a.splice(c, 1) : c &&
        ".." == a[c] && a[c - 1] && ".." != a[c - 1] ? a.splice(--c, 2) :
        c++;
    return a.join("/")
};
m.loadFileSync_ = function (a) {
    if (m.global.CLOSURE_LOAD_FILE_SYNC) return m.global
...
m.transpile_ = function (a, c, d) {
    ...
    if (!f) {
        ...
        if (h) {
            ...
            if (m.global.$gwtExport && m.global.$gwtExport.$jscomp && !m
            ...
            m.global.$jscomp.transpile = m.global.$gwtExport.$jscomp
                .transpile;
            e = m.global.$jscomp;
            f = e.transpile
        }
...
m.getUid = function (a) {
    return Object.prototype.hasOwnProperty.call(a, m.UID_PROPERTY_) && a[m
        .UID_PROPERTY_] || (a[m.UID_PROPERTY_] = ++m.uidCounter_)
};
m.hasUid = function (a) {
    return !!a[m.UID_PROPERTY_]
};
m.removeUid = function (a) {
    null !== a && "removeAttribute" in a && a.removeAttribute(m
        .UID_PROPERTY_);
    try {
...
m.bind = function (a, c, d) {
    Function.prototype.bind && -1 != Function.prototype.bind.toString()
        .indexOf("native code") ? m.bind = m.bindNative_ : m.bind = m
        .bindJs_;
...
m.getCssName = function (a, c) {
    ...
    e = m.cssNameMapping_ ? "BY_WHOLE" == m.cssNameMappingStyle_ ? d : e :
        function (f) {
            return f
        };
    a = c ? a + "-" + e(c) : e(a);
    return m.global.CLOSURE_CSS_NAME_MAP_FN ? m.global
...
m.getMsg = function (a, c, d) {
    ...
    d && d.unescapeHtmlEntities && (a = a.replace(/&lt;/g, "<").replace(
        /&gt;/g, ">").replace(/&apos;/g, "'").replace(/&quot;/g,
        '"').replace(/&amp;/g, "&"));
    c && (a = a.replace(/\{\$([^}]+)}/g, function (e, f) {
...
m.inherits = function (a, c) {
    ...
    a.base = function (e, f, g) {
        for (var h = Array(arguments.length - 2), l = 2; l < arguments
            .length; l++) h[l - 2] = arguments[l];
...
m.defineClass = function (a, c) {
    ...
    null != e && (e instanceof Function ? e(d) : m.defineClass
        .applyProperties_(d, e));
    return d
};
m.defineClass.SEAL_CLASS_INSTANCES = m.DEBUG;
m.defineClass.createSealingConstructor_ = function (a) {
    return m.defineClass.SEAL_CLASS_INSTANCES ? function () {
...
m.defineClass.applyProperties_ = function (a, c) {
    for (var d in c) Object.prototype.hasOwnProperty.call(c, d) && (a[d] =
        c[d]);
    for (var e = 0; e < m.defineClass.OBJECT_PROTOTYPE_FIELDS_.length; e++)
        d = m.defineClass.OBJECT_PROTOTYPE_FIELDS_[e], Object.prototype
...
m.asserts.subs_ = function (a, c) {
    a = a.split("%s");
    for (var d = "", e = a.length - 1, f = 0; f < e; f++) d += a[f] + (f < c
        .length ? c[f] : "%s");
    return d + a[e]
};
...
m.asserts.assert = function (a, c, d) {
    m.asserts.ENABLE_ASSERTS && !a && m.asserts.doAssertFailure_("", null,
        c, Array.prototype.slice.call(arguments, 2));
    return a
};
m.asserts.assertExists = function (a, c, d) {
    m.asserts.ENABLE_ASSERTS && null == a && m.asserts.doAssertFailure_(
        "Expected to exist: %s.", [a], c, Array.prototype.slice.call(
            arguments, 2));
    return a
};
m.asserts.fail = function (a, c) {
    m.asserts.ENABLE_ASSERTS && m.asserts.errorHandler_(new m.asserts
        .AssertionError("Failure" + (a ? ": " + a : ""), Array.prototype
            .slice.call(arguments, 1)))
};
m.asserts.assertNumber = function (a, c, d) {
    m.asserts.ENABLE_ASSERTS && "number" !== typeof a && m.asserts
        .doAssertFailure_("Expected number but got %s: %s.", [m.typeOf(a),
            a], c, Array.prototype.slice.call(arguments, 2));
    return a
};
m.asserts.assertString = function (a, c, d) {
    m.asserts.ENABLE_ASSERTS && "string" !== typeof a && m.asserts
        .doAssertFailure_("Expected string but got %s: %s.", [m.typeOf(a),
            a], c, Array.prototype.slice.call(arguments, 2))
};
m.asserts.assertFunction = function (a, c, d) {
    m.asserts.ENABLE_ASSERTS && "function" !== typeof a && m.asserts
        .doAssertFailure_("Expected function but got %s: %s.", [m.typeOf(a),
            a
        ], c, Array.prototype.slice.call(arguments, 2))
};
m.asserts.assertObject = function (a, c, d) {
    m.asserts.ENABLE_ASSERTS && !m.isObject(a) && m.asserts
        .doAssertFailure_("Expected object but got %s: %s.", [m.typeOf(a),
            a], c, Array.prototype.slice.call(arguments, 2));
    return a
};
m.asserts.assertArray = function (a, c, d) {
    m.asserts.ENABLE_ASSERTS && !Array.isArray(a) && m.asserts
        .doAssertFailure_("Expected array but got %s: %s.", [m.typeOf(a),
            a], c, Array.prototype.slice.call(arguments, 2))
};
m.asserts.assertBoolean = function (a, c, d) {
    m.asserts.ENABLE_ASSERTS && "boolean" !== typeof a && m.asserts
        .doAssertFailure_("Expected boolean but got %s: %s.", [m.typeOf(a),
            a
        ], c, Array.prototype.slice.call(arguments, 2));
    return a
};
m.asserts.assertElement = function (a, c, d) {
    !m.asserts.ENABLE_ASSERTS || m.isObject(a) && a.nodeType == m.dom
        .NodeType.ELEMENT || m.asserts.doAssertFailure_(
            "Expected Element but got %s: %s.", [m.typeOf(a), a], c, Array
            .prototype.slice.call(arguments, 2));
    return a
};
m.asserts.assertInstanceof = function (a, c, d, e) {
    !m.asserts.ENABLE_ASSERTS || a instanceof c || m.asserts
        .doAssertFailure_("Expected instanceof %s but got %s.", [m.asserts
            .getType_(c), m.asserts.getType_(a)
        ], d, Array.prototype.slice.call(arguments, 3));
    return a
};
m.asserts.assertFinite = function (a, c, d) {
    !m.asserts.ENABLE_ASSERTS || "number" == typeof a && isFinite(a) || m
        .asserts.doAssertFailure_(
            "Expected %s to be a finite number but it is not.", [a], c,
            Array.prototype.slice.call(arguments, 2));
    return a
};
m.asserts.assertObjectPrototypeIsIntact = function () {
    for (var a in Object.prototype) m.asserts.fail(a +
...
m.array.peek = aa;
m.array.last = aa;
var ba = m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.indexOf) ?
    function (a, c, d) {
        m.asserts.assert(null != a.length);
        return Array.prototype.indexOf.call(a, c, d)
    } : function (a, c, d) {
        d = null == d ? 0 : 0 > d ? Math.max(0, a.length + d) : d;
        if ("string" === typeof a) return "string" !== typeof c || 1 != c
            .length ? -1 : a.indexOf(c, d);
        for (; d < a.length; d++)
            if (d in a && a[d] === c) return d;
        return -1
    };
m.array.indexOf = ba;
var ca = m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.lastIndexOf) ?
    function (a, c, d) {
        m.asserts.assert(null != a.length);
        return Array.prototype.lastIndexOf.call(a, c, null == d ? a.length - 1 :
            d)
    } : function (a, c, d) {
        d = null == d ? a.length - 1 : d;
        0 > d && (d = Math.max(0, a.length + d));
        if ("string" === typeof a) return "string" !== typeof c || 1 != c
            .length ? -1 : a.lastIndexOf(c, d);
        for (; 0 <= d; d--)
            if (d in a && a[d] === c) return d;
        return -1
    };
m.array.lastIndexOf = ca;
var w = m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.forEach) ? function (
    a, c, d) {
    m.asserts.assert(null != a.length);
    Array.prototype.forEach.call(a, c, d)
} : function (a, c, d) {
    for (var e = a.length, f = "string" === typeof a ? a.split("") : a, g =
            0; g < e; g++) g in f && c.call(d, f[g], g, a)
};
m.array.forEach = w;
...
var ea = m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.filter) ? function (
    a, c, d) {
    m.asserts.assert(null != a.length);
    return Array.prototype.filter.call(a, c, d)
} : function (a, c, d) {
    for (var e = a.length, f = [], g = 0, h = "string" === typeof a ? a
            .split("") : a, l = 0; l < e; l++)
        if (l in h) {
            var n = h[l];
...
m.array.filter = ea;
var x = m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.map) ? function (a,
    c, d) {
    m.asserts.assert(null != a.length);
    return Array.prototype.map.call(a, c, d)
} : function (a, c, d) {
    for (var e = a.length, f = Array(e), g = "string" === typeof a ? a
            .split("") : a, h = 0; h < e; h++) h in g && (f[h] = c.call(d,
        g[h], h, a));
    return f
};
m.array.map = x;
var fa = m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.reduce) ? function (
    a, c, d, e) {
    m.asserts.assert(null != a.length);
    e && (c = m.bind(c, e));
...
m.array.reduce = fa;
m.array.reduceRight = m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype
    .reduceRight) ? function (a, c, d, e) {
    m.asserts.assert(null != a.length);
...
var ha = m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.some) ? function (a,
    c, d) {
    m.asserts.assert(null != a.length);
...
m.array.some = ha;
var ia = m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.every) ? function (
    a, c, d) {
    m.asserts.assert(null != a.length);
...
function la(a, c, d) {
    var e = a.length,
        f = "string" === typeof a ? a.split("") : a;
    for (--e; 0 <= e; e--)
        if (e in f && c.call(d, f[e], e, a)) return e;
    return -1
}
...
function D(a, c, d) {
    m.asserts.assert(null != a.length);
    return 2 >= arguments.length ? Array.prototype.slice.call(a, c) : Array
        .prototype.slice.call(a, c, d)
}
m.array.slice = D;
...
m.array.rotate = function (a, c) {
    m.asserts.assert(null != a.length);
    a.length && (c %= a.length, 0 < c ? Array.prototype.unshift.apply(a, a
        .splice(-c, c)) : 0 > c && Array.prototype.push.apply(a, a
        .splice(0, -c)));
    return a
};
...
m.array.zip = function (a) {
    ...
    for (var c = [], d = arguments[0].length, e = 1; e < arguments
        .length; e++) arguments[e].length < d && (d = arguments[e].length);
    for (e = 0; e < d; e++) {
...
m.debug.errorcontext.addErrorContext = function (a, c, d) {
    a[m.debug.errorcontext.CONTEXT_KEY_] || (a[m.debug.errorcontext
        .CONTEXT_KEY_] = {});
...
m.string.internal.caseInsensitiveStartsWith = function (a, c) {
    return 0 == m.string.internal.caseInsensitiveCompare(c, a.substr(0, c
        .length))
};
m.string.internal.caseInsensitiveEndsWith = function (a, c) {
    return 0 == m.string.internal.caseInsensitiveCompare(c, a.substr(a
...
m.string.internal.trim = m.TRUSTED_SITE && String.prototype.trim ? function (
a) {
    return a.trim()
} : function (a) {
...
m.string.internal.htmlEscape = function (a, c) {
    if (c) a = a.replace(m.string.internal.AMP_RE_, "&amp;").replace(m
            .string.internal.LT_RE_, "&lt;").replace(m.string.internal
            .GT_RE_, "&gt;").replace(m.string.internal.QUOT_RE_, "&quot;")
        .replace(m.string.internal.SINGLE_QUOTE_RE_, "&#39;").replace(m
            .string.internal.NULL_RE_, "&#0;");
    else {
        if (!m.string.internal.ALL_RE_.test(a)) return a; - 1 != a.indexOf(
            "&") && (a = a.replace(m.string.internal.AMP_RE_, "&amp;")); - 1
            != a.indexOf("<") && (a = a.replace(m.string.internal.LT_RE_,
                "&lt;")); -
        1 != a.indexOf(">") && (a = a.replace(m.string.internal.GT_RE_,
            "&gt;")); - 1 != a.indexOf('"') && (a = a.replace(m.string
            .internal.QUOT_RE_, "&quot;")); - 1 != a.indexOf("'") && (a = a
            .replace(m.string.internal.SINGLE_QUOTE_RE_, "&#39;")); - 1 != a
            .indexOf("\x00") && (a = a.replace(m.string.internal.NULL_RE_,
                "&#0;"))
    }
    return a
};
...
m.string.internal.whitespaceEscape = function (a) {
    return m.string.internal.newLineToBr(a.replace(/  /g, " &#160;"),
        void 0)
};
...
m.string.internal.compareVersions = function (a, c) {
    ...
    for (var e = Math.max(a.length, c.length), f = 0; 0 == d && f <
        e; f++) {
        var g = a[f] || "",
            h = c[f] || "";
        do {
            ...
            d = m.string.internal.compareElements_(0 == g[1].length ? 0 :
                    parseInt(g[1], 10), 0 == h[1].length ? 0 : parseInt(h[
                        1], 10)) || m.string.internal.compareElements_(0 ==
                    g[2].length, 0 == h[2].length) || m.string.internal
                .compareElements_(g[2], h[2]);
            g = g[3];
            h = h[3]
        } while (0 == d)
    }
...
m.labs.userAgent.util.userAgent_ = m.labs.userAgent.util
    .getNativeUserAgentString_();
m.labs.userAgent.util.setUserAgent = function (a) {
    m.labs.userAgent.util.userAgent_ = a || m.labs.userAgent.util
        .getNativeUserAgentString_()
};
...
m.labs.userAgent.util.matchUserAgent = function (a) {
    return m.string.internal.contains(m.labs.userAgent.util.getUserAgent(),
        a)
};
m.labs.userAgent.util.matchUserAgentIgnoreCase = function (a) {
    return m.string.internal.caseInsensitiveContains(m.labs.userAgent.util
        .getUserAgent(), a)
};
m.labs.userAgent.util.extractVersionTuples = function (a) {
    for (var c = /(\w[\w ]+)\/([^\s]+)\s*(?:\((.*?)\))?/g, d = [], e; e = c
        .exec(a);) d.push([e[1], e[2], e[3] || void 0]);
    return d
};
m.object = {};
...
m.object.add = function (a, c, d) {
    if (null !== a && c in a) throw Error(
        'The object already contains the key "' + c + '"');
    m.object.set(a, c, d)
};
...
m.object.unsafeClone = function (a) {
    ...
    if ("function" === typeof a.clone) return a.clone();
    var c = Array.isArray(a) ? [] : "function" !== typeof ArrayBuffer ||
...
m.object.extend = function (a, c) {
    for (var d, e, f = 1; f < arguments.length; f++) {
        e = arguments[f];
        for (d in e) a[d] = e[d];
        for (var g = 0; g < m.object.PROTOTYPE_FIELDS_.length; g++) d = m
            .object.PROTOTYPE_FIELDS_[g], Object.prototype.hasOwnProperty
            .call(e, d) && (a[d] = e[d])
    }
};
m.object.create = function (a) {
    var c = arguments.length;
    if (1 == c && Array.isArray(arguments[0])) return m.object.create.apply(
        null, arguments[0]);
    if (c % 2) throw Error("Uneven number of arguments");
    for (var d = {}, e = 0; e < c; e += 2) d[arguments[e]] = arguments[e +
        1];
    return d
};
m.object.createSet = function (a) {
    var c = arguments.length;
    if (1 == c && Array.isArray(arguments[0])) return m.object.createSet
...
m.object.createImmutableView = function (a) {
    var c = a;
    Object.isFrozen && !Object.isFrozen(a) && (c = Object.create(a), Object
        .freeze(c));
    return c
};
...
m.object.getAllPropertyNames = function (a, c, d) {
    if (!a) return [];
    if (!Object.getOwnPropertyNames || !Object.getPrototypeOf) return m
        .object.getKeys(a);
    for (var e = {}; a && (a !== Object.prototype || c) && (a !== Function
            .prototype || d);) {
        for (var f = Object.getOwnPropertyNames(a), g = 0; g < f
            .length; g++) e[f[g]] = !0;
...
m.labs.userAgent.browser.matchIE_ = function () {
    return m.labs.userAgent.util.matchUserAgent("Trident") || m.labs
...
m.labs.userAgent.browser.matchFirefox_ = function () {
    return m.labs.userAgent.util.matchUserAgent("Firefox") || m.labs
        .userAgent.util.matchUserAgent("FxiOS")
};
m.labs.userAgent.browser.matchSafari_ = function () {
    return m.labs.userAgent.util.matchUserAgent("Safari") && !(m.labs
        .userAgent.browser.matchChrome_() || m.labs.userAgent.browser
        .matchCoast_() || m.labs.userAgent.browser.matchOpera_() || m
        .labs.userAgent.browser.matchEdgeHtml_() || m.labs.userAgent
        .browser.matchEdgeChromium_() || m.labs.userAgent.browser
        .matchOperaChromium_() || m.labs.userAgent.browser
        .matchFirefox_() || m.labs.userAgent.browser.isSilk() || m.labs
...
m.labs.userAgent.browser.matchIosWebview_ = function () {
    return (m.labs.userAgent.util.matchUserAgent("iPad") || m.labs.userAgent
            .util.matchUserAgent("iPhone")) && !m.labs.userAgent.browser
        .matchSafari_() && !m.labs.userAgent.browser.matchChrome_() && !m
        .labs.userAgent.browser.matchCoast_() && !m.labs.userAgent.browser
        .matchFirefox_() && m.labs.userAgent.util.matchUserAgent(
            "AppleWebKit")
};
m.labs.userAgent.browser.matchChrome_ = function () {
    return (m.labs.userAgent.util.matchUserAgent("Chrome") || m.labs
            .userAgent.util.matchUserAgent("CriOS")) && !m.labs.userAgent
        .browser.matchEdgeHtml_()
};
m.labs.userAgent.browser.matchAndroidBrowser_ = function () {
    return m.labs.userAgent.util.matchUserAgent("Android") && !(m.labs
        .userAgent.browser.isChrome() || m.labs.userAgent.browser
        .isFirefox() || m.labs.userAgent.browser.isOpera() || m.labs
...
m.labs.userAgent.browser.isEdgeChromium = m.labs.userAgent.browser
    .matchEdgeChromium_;
m.labs.userAgent.browser.isOperaChromium = m.labs.userAgent.browser
    .matchOperaChromium_;
...
m.labs.userAgent.browser.isIosWebview = m.labs.userAgent.browser
    .matchIosWebview_;
m.labs.userAgent.browser.isChrome = m.labs.userAgent.browser.matchChrome_;
m.labs.userAgent.browser.isAndroidBrowser = m.labs.userAgent.browser
...
m.labs.userAgent.browser.getVersion = function () {
    ...
    if (m.labs.userAgent.browser.isIE()) return m.labs.userAgent.browser
        .getIEVersion_(c);
    ...
    return m.labs.userAgent.browser.isOpera() ? a(["Version", "Opera"]) : m
        .labs.userAgent.browser.isEdge() ? a(["Edge"]) : m.labs.userAgent
        .browser.isEdgeChromium() ? a(["Edg"]) :
        m.labs.userAgent.browser.isChrome() ? a(["Chrome", "CriOS",
            "HeadlessChrome"
        ]) : (c = c[2]) && c[1] || ""
};
m.labs.userAgent.browser.isVersionOrHigher = function (a) {
    return 0 <= m.string.internal.compareVersions(m.labs.userAgent.browser
        .getVersion(), a)
};
...
m.dom.asserts.assertIsElementType_ = function (a, c) {
    if (m.asserts.ENABLE_ASSERTS) {
        ...
        d && "undefined" != typeof d[c] && (a && (a instanceof d[c] || !(
                a instanceof d.Location || a instanceof d.Element)) || m
            .asserts.fail(
                "Argument is not a %s (or a non-Element, non-Location mock); got: %s",
                c, m.dom.asserts.debugStringForType_(a)))
    }
    return a
};
...
m.html.trustedtypes.getPolicyPrivateDoNotAccessOrElse = function () {
    ...
    void 0 === m.html.trustedtypes.cachedPolicy_ && (m.html.trustedtypes
        .cachedPolicy_ = m.createTrustedTypesPolicy());
...
m.string.Const = function (a, c) {
    this.stringConstValueWithSecurityContract__googStringSecurityPrivate_ =
        ...
        "";
    this.STRING_CONST_TYPE_MARKER__GOOG_STRING_SECURITY_PRIVATE_ = m.string
        .Const.TYPE_MARKER_
};
...
m.DEBUG && (m.string.Const.prototype.toString = function () {
    return "Const{" + this
        .stringConstValueWithSecurityContract__googStringSecurityPrivate_ +
        "}"
});
m.string.Const.unwrap = function (a) {
    if (a instanceof m.string.Const && a.constructor === m.string.Const && a
        .STRING_CONST_TYPE_MARKER__GOOG_STRING_SECURITY_PRIVATE_ === m
...
m.string.Const.from = function (a) {
    return new m.string.Const(m.string.Const
...
var Ca = function (a) {
        if (a instanceof G && a.constructor === G) return a
            .privateDoNotAccessOrElseSafeScriptWrappedValue_;
        (0, m.asserts.fail)("expected object of type SafeScript, got '" + a +
            "' of type " + m.typeOf(a));
...
m.fs.url.findUrlObject_ = function () {
    return void 0 !== m.global.URL && void 0 !== m.global.URL
        .createObjectURL ? m.global.URL : void 0 !== m.global
        .createObjectURL ? m.global : null
};
...
m.fs.blob.getBlobWithProperties = function (a, c) {
    ...
    if (void 0 !== m.global.Blob) return d = {}, c && (d.type = c),
        new Blob(a, d);
...
m.i18n.bidi.IS_RTL = m.i18n.bidi.FORCE_RTL || ("ar" == m.LOCALE.substring(0, 2)
        .toLowerCase() || "fa" == m.LOCALE.substring(0, 2).toLowerCase() ||
        "he" == m.LOCALE.substring(0, 2).toLowerCase() || "iw" == m.LOCALE
        .substring(0, 2).toLowerCase() || "ps" == m.LOCALE.substring(0, 2)
        .toLowerCase() || "sd" == m.LOCALE.substring(0, 2).toLowerCase() ||
        "ug" == m.LOCALE.substring(0, 2).toLowerCase() || "ur" == m.LOCALE
        .substring(0, 2).toLowerCase() || "yi" == m.LOCALE.substring(0, 2)
        .toLowerCase()) && (2 == m.LOCALE.length || "-" == m.LOCALE.substring(2,
            3) || "_" ==
        m.LOCALE.substring(2, 3)) || 3 <= m.LOCALE.length && "ckb" == m.LOCALE
    .substring(0, 3).toLowerCase() && (3 == m.LOCALE.length || "-" == m.LOCALE
        .substring(3, 4) || "_" == m.LOCALE.substring(3, 4)) || 7 <= m.LOCALE
    .length && ("-" == m.LOCALE.substring(2, 3) || "_" == m.LOCALE.substring(2,
        3)) && ("adlm" == m.LOCALE.substring(3, 7).toLowerCase() || "arab" == m
        .LOCALE.substring(3, 7).toLowerCase() || "hebr" == m.LOCALE.substring(3,
            7).toLowerCase() || "nkoo" == m.LOCALE.substring(3, 7)
    .toLowerCase() || "rohg" == m.LOCALE.substring(3, 7).toLowerCase() ||
        "thaa" == m.LOCALE.substring(3,
            7).toLowerCase()) || 8 <= m.LOCALE.length && ("-" == m.LOCALE
        .substring(3, 4) || "_" == m.LOCALE.substring(3, 4)) && ("adlm" == m
        .LOCALE.substring(4, 8).toLowerCase() || "arab" == m.LOCALE.substring(4,
            8).toLowerCase() || "hebr" == m.LOCALE.substring(4, 8)
    .toLowerCase() || "nkoo" == m.LOCALE.substring(4, 8).toLowerCase() ||
        "rohg" == m.LOCALE.substring(4, 8).toLowerCase() || "thaa" == m.LOCALE
...
m.i18n.bidi.I18N_RIGHT = m.i18n.bidi.IS_RTL ? m.i18n.bidi.LEFT : m.i18n.bidi
    .RIGHT;
m.i18n.bidi.I18N_LEFT = m.i18n.bidi.IS_RTL ? m.i18n.bidi.RIGHT : m.i18n.bidi
    .LEFT;
m.i18n.bidi.toDir = function (a) {
    return "number" == typeof a ? 0 < a ? m.i18n.bidi.Dir.LTR : 0 > a ? m
        .i18n.bidi.Dir.RTL : m.i18n.bidi.Dir.NEUTRAL : null == a ? null :
        a ? m.i18n.bidi.Dir.RTL : m.i18n.bidi.Dir.LTR
};
...
m.i18n.bidi.hasAnyRtl = function (a, c) {
    return m.i18n.bidi.rtlCharReg_.test(m.i18n.bidi.stripHtmlIfNeeded_(a,
        c))
};
m.i18n.bidi.hasRtlChar = m.i18n.bidi.hasAnyRtl;
m.i18n.bidi.hasAnyLtr = function (a) {
    return m.i18n.bidi.ltrCharReg_.test(m.i18n.bidi.stripHtmlIfNeeded_(a,
        void 0))
};
...
m.i18n.bidi.ltrDirCheckRe_ = new RegExp("^[^" + m.i18n.bidi.rtlChars_ + "]*[" +
    m.i18n.bidi.ltrChars_ + "]");
m.i18n.bidi.rtlDirCheckRe_ = new RegExp("^[^" + m.i18n.bidi.ltrChars_ + "]*[" +
    m.i18n.bidi.rtlChars_ + "]");
m.i18n.bidi.startsWithRtl = function (a, c) {
    return m.i18n.bidi.rtlDirCheckRe_.test(m.i18n.bidi.stripHtmlIfNeeded_(a,
        c))
};
m.i18n.bidi.isRtlText = m.i18n.bidi.startsWithRtl;
m.i18n.bidi.startsWithLtr = function (a, c) {
    return m.i18n.bidi.ltrDirCheckRe_.test(m.i18n.bidi.stripHtmlIfNeeded_(a,
        c))
};
...
m.i18n.bidi.isNeutralText = function (a, c) {
    ...
    return m.i18n.bidi.isRequiredLtrRe_.test(a) || !m.i18n.bidi.hasAnyLtr(
        a) && !m.i18n.bidi.hasAnyRtl(a)
};
m.i18n.bidi.ltrExitDirCheckRe_ = new RegExp("[" + m.i18n.bidi.ltrChars_ +
    "][^" + m.i18n.bidi.rtlChars_ + "]*$");
m.i18n.bidi.rtlExitDirCheckRe_ = new RegExp("[" + m.i18n.bidi.rtlChars_ +
    "][^" + m.i18n.bidi.ltrChars_ + "]*$");
m.i18n.bidi.endsWithLtr = function (a, c) {
    return m.i18n.bidi.ltrExitDirCheckRe_.test(m.i18n.bidi
        .stripHtmlIfNeeded_(a, c))
};
m.i18n.bidi.isLtrExitText = m.i18n.bidi.endsWithLtr;
m.i18n.bidi.endsWithRtl = function (a, c) {
    return m.i18n.bidi.rtlExitDirCheckRe_.test(m.i18n.bidi
        .stripHtmlIfNeeded_(a, c))
};
...
m.i18n.bidi.guardBracketInText = function (a, c) {
    c = (void 0 === c ? m.i18n.bidi.hasAnyRtl(a) : c) ? m.i18n.bidi.Format
        .RLM : m.i18n.bidi.Format.LRM;
...
m.i18n.bidi.mirrorCSS = function (a) {
    return a.replace(m.i18n.bidi.dimensionsRe_, ":$1 $4 $3 $2").replace(m
        .i18n.bidi.leftRe_, "%%%%").replace(m.i18n.bidi.rightRe_, m.i18n
        .bidi.LEFT).replace(m.i18n.bidi.tempRe_, m.i18n.bidi.RIGHT)
};
...
m.i18n.bidi.normalizeHebrewQuote = function (a) {
    return a.replace(m.i18n.bidi.doubleQuoteSubstituteRe_, "$1\u05f4")
        .replace(m.i18n.bidi.singleQuoteSubstituteRe_, "$1\u05f3")
};
m.i18n.bidi.wordSeparatorRe_ = /\s+/;
m.i18n.bidi.hasNumeralsRe_ = /[\d\u06f0-\u06f9]/;
m.i18n.bidi.rtlDetectionThreshold_ = .4;
m.i18n.bidi.estimateDirection = function (a, c) {
    var d = 0,
        e = 0,
        f = !1;
    a = m.i18n.bidi.stripHtmlIfNeeded_(a, c).split(m.i18n.bidi
        .wordSeparatorRe_);
    for (c = 0; c < a.length; c++) {
        var g = a[c];
        m.i18n.bidi.startsWithRtl(g) ? (d++, e++) : m.i18n.bidi
            .isRequiredLtrRe_.test(g) ? f = !0 : m.i18n.bidi.hasAnyLtr(g) ?
            e++ : m.i18n.bidi.hasNumeralsRe_.test(g) && (f = !0)
    }
    return 0 == e ? f ? m.i18n.bidi.Dir.LTR : m.i18n.bidi.Dir.NEUTRAL : d /
        e > m.i18n.bidi.rtlDetectionThreshold_ ? m.i18n.bidi.Dir.RTL : m
        .i18n.bidi.Dir.LTR
};
...
m.i18n.bidi.setElementDirAndAlign = function (a, c) {
    a && (c = m.i18n.bidi.toDir(c)) && (a.style.textAlign = c == m.i18n.bidi
        .Dir.RTL ? m.i18n.bidi.RIGHT : m.i18n.bidi.LEFT, a.dir = c == m
...
m.html.TrustedResourceUrl = function (a, c) {
    this.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue_ = c === m
...
m.html.TrustedResourceUrl.unwrapTrustedScriptURL = function (a) {
    if (a instanceof m.html.TrustedResourceUrl && a.constructor === m.html
        .TrustedResourceUrl) return a
        .privateDoNotAccessOrElseTrustedResourceUrlWrappedValue_;
    m.asserts.fail("expected object of type TrustedResourceUrl, got '" + a +
        "' of type " + m.typeOf(a));
    return "type_error:TrustedResourceUrl"
};
m.html.TrustedResourceUrl.format = function (a, c) {
    var d = m.string.Const.unwrap(a);
    if (!m.html.TrustedResourceUrl.BASE_URL_.test(d)) throw Error(
        "Invalid TrustedResourceUrl format: " + d);
    a = d.replace(m.html.TrustedResourceUrl.FORMAT_MARKER_, function (e,
    f) {
        if (!Object.prototype.hasOwnProperty.call(c, f))
        throw Error('Found marker, "' + f +
                '", in format string, "' + d +
                '", but no valid label mapping found in args: ' +
                JSON.stringify(c));
        e = c[f];
        return e instanceof m.string.Const ? m.string.Const.unwrap(
            e) : encodeURIComponent(String(e))
    });
    return m.html.TrustedResourceUrl
...
m.html.TrustedResourceUrl.formatWithParams = function (a, c, d, e) {
    ...
    c = a[3] || "";
    return m.html.TrustedResourceUrl
        .createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(a[1] + m
            .html.TrustedResourceUrl.stringifyParams_("?", a[2] || "", d) +
            m.html.TrustedResourceUrl.stringifyParams_("#", c, e))
};
m.html.TrustedResourceUrl.fromConstant = function (a) {
    return m.html.TrustedResourceUrl
        .createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(m.string
            .Const.unwrap(a))
};
m.html.TrustedResourceUrl.fromConstants = function (a) {
    for (var c = "", d = 0; d < a.length; d++) c += m.string.Const.unwrap(a[
        d]);
    return m.html.TrustedResourceUrl
        .createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(c)
};
    ...
    for (var e in d)
        if (Object.prototype.hasOwnProperty.call(d, e)) {
            ...
            for (var g = 0; g < f.length; g++) {
                var h = f[g];
                null != h && (c || (c = a), c += (c.length > a.length ?
...
m.html.SafeUrl = function (a, c) {
    this.privateDoNotAccessOrElseSafeUrlWrappedValue_ = c === m.html.SafeUrl
...
m.html.SafeUrl.unwrap = function (a) {
    ...
    m.asserts.fail("expected object of type SafeUrl, got '" + a +
        "' of type " + m.typeOf(a));
    return "type_error:SafeUrl"
};
m.html.SafeUrl.fromConstant = function (a) {
    return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(m
...
m.html.SafeUrl.fromBlob = function (a) {
    a = m.html.SafeUrl.isSafeMimeType(a.type) ? m.fs.url.createObjectUrl(
...
m.html.SafeUrl.fromMediaSource = function (a) {
    m.asserts.assert("MediaSource" in m.global,
        "No support for MediaSource");
    a = a instanceof MediaSource ? m.fs.url.createObjectUrl(a) : m.html
...
m.html.SafeUrl.tryFromDataUrl = function (a) {
    ...
    return c && m.html.SafeUrl.isSafeMimeType(c[1]) ? m.html.SafeUrl
...
m.html.SafeUrl.fromTelUrl = function (a) {
    m.string.internal.caseInsensitiveStartsWith(a, "tel:") || (a = m.html
        .SafeUrl.INNOCUOUS_STRING);
    return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a)
};
...
m.html.SafeUrl.fromSipUrl = function (a) {
    m.html.SIP_URL_PATTERN_.test(decodeURIComponent(a)) || (a = m.html
        .SafeUrl.INNOCUOUS_STRING);
    return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a)
};
m.html.SafeUrl.fromFacebookMessengerUrl = function (a) {
    m.string.internal.caseInsensitiveStartsWith(a,
        "fb-messenger://share") || (a = m.html.SafeUrl.INNOCUOUS_STRING);
    return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a)
};
...
m.html.SafeUrl.fromSmsUrl = function (a) {
    m.string.internal.caseInsensitiveStartsWith(a, "sms:") && m.html.SafeUrl
        .isSmsUrlBodyValid_(a) || (a = m.html.SafeUrl.INNOCUOUS_STRING);
    return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a)
};
...
m.html.SafeUrl.sanitizeEdgeExtensionUrl = function (a, c) {
    return m.html.SafeUrl.sanitizeExtensionUrl_(
        /^ms-browser-extension:\/\/([^\/]+)\//, a, c)
};
m.html.SafeUrl.sanitizeExtensionUrl_ = function (a, c, d) {
    (a = a.exec(c)) ? (a = a[1], -1 == (d instanceof m.string.Const ? [m
        .string.Const.unwrap(d)
    ] : d.map(function (e) {
        return m.string.Const.unwrap(e)
    })).indexOf(a) && (c = m.html.SafeUrl.INNOCUOUS_STRING)) : c = m.html
        .SafeUrl.INNOCUOUS_STRING;
...
m.html.SafeUrl.trySanitize = function (a) {
    ...
    return m.html.SAFE_URL_PATTERN_.test(a) ? m.html.SafeUrl
        .createSafeUrlSecurityPrivateDoNotAccessOrElse(a) : m.html.SafeUrl
        .tryFromDataUrl(a)
};
...
m.html.SafeUrl.sanitizeAssertUnchanged = function (a, c) {
    ...
    a = "object" == typeof a && a.implementsGoogStringTypedString ? a
        .getTypedStringValue() : String(a);
    if (c && /^data:/i.test(a) && (c = m.html.SafeUrl.fromDataUrl(a), c
            .getTypedStringValue() == a)) return c;
    m.asserts.assert(m.html.SAFE_URL_PATTERN_.test(a),
        "%s does not match the safe URL pattern", a) || (a = m.html
        .SafeUrl.INNOCUOUS_STRING);
    return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a)
};
...
m.html.SafeUrl.INNOCUOUS_URL = m.html.SafeUrl
    .createSafeUrlSecurityPrivateDoNotAccessOrElse(m.html.SafeUrl
        .INNOCUOUS_STRING);
m.html.SafeUrl.ABOUT_BLANK = m.html.SafeUrl
    .createSafeUrlSecurityPrivateDoNotAccessOrElse("about:blank");
m.html.SafeStyle = function (a, c) {
    this.privateDoNotAccessOrElseSafeStyleWrappedValue_ = c === m.html
...
m.html.SafeStyle.fromConstant = function (a) {
    ...
    m.asserts.assert(m.string.internal.endsWith(a, ";"),
        "Last character of style string is not ';': " + a);
    m.asserts.assert(m.string.internal.contains(a, ":"),
        "Style string must contain at least one ':', to specify a \"name: value\" pair: " +
        a);
    return m.html.SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse(
        a)
};
...
m.html.SafeStyle.unwrap = function (a) {
    ...
    m.asserts.fail("expected object of type SafeStyle, got '" + a +
        "' of type " + m.typeOf(a));
...
a) {
    return new m.html.SafeStyle(a, m.html.SafeStyle
        .CONSTRUCTOR_TOKEN_PRIVATE_)
};
m.html.SafeStyle.EMPTY = m.html.SafeStyle
...
m.html.SafeStyle.create = function (a) {
    ...
    for (d in a)
        if (Object.prototype.hasOwnProperty.call(a, d)) {
            if (!/^[-_a-zA-Z0-9]+$/.test(d)) throw Error(
                "Name allows only [-_a-zA-Z0-9], got: " + d);
            var e = a[d];
            null != e && (e = Array.isArray(e) ? x(e, m.html.SafeStyle
                    .sanitizePropertyValue_).join(" ") : m.html
                .SafeStyle.sanitizePropertyValue_(e), c += d + ":" + e +
                ";")
        } return c ? m.html.SafeStyle
        .createSafeStyleSecurityPrivateDoNotAccessOrElse(c) : m.html
        .SafeStyle.EMPTY
};
m.html.SafeStyle.sanitizePropertyValue_ = function (a) {
    if (a instanceof m.html.SafeUrl) return 'url("' + m.html.SafeUrl.unwrap(
        a).replace(/</g, "%3c").replace(/[\\"]/g, "\\$&") + '")';
    a = a instanceof m.string.Const ? m.string.Const.unwrap(a) : m.html
        .SafeStyle.sanitizePropertyValueString_(String(a));
    if (/[{;}]/.test(a)) throw new m.asserts.AssertionError(
        "Value does not allow [{;}], got: %s.", [a]);
    return a
};
m.html.SafeStyle.sanitizePropertyValueString_ = function (a) {
    var c = a.replace(m.html.SafeStyle.FUNCTIONS_RE_, "$1").replace(m.html
        .SafeStyle.FUNCTIONS_RE_, "$1").replace(m.html.SafeStyle
        .URL_RE_, "url");
    if (m.html.SafeStyle.VALUE_RE_.test(c)) {
        if (m.html.SafeStyle.COMMENT_RE_.test(a)) return m.asserts.fail(
                "String value disallows comments, got: " + a), m.html
            .SafeStyle.INNOCUOUS_STRING;
        if (!m.html.SafeStyle.hasBalancedQuotes_(a)) return m.asserts.fail(
                "String value requires balanced quotes, got: " + a), m
            .html.SafeStyle.INNOCUOUS_STRING;
        if (!m.html.SafeStyle.hasBalancedSquareBrackets_(a)) return m
            .asserts.fail(
                "String value requires balanced square brackets and one identifier per pair of brackets, got: " +
                a), m.html.SafeStyle.INNOCUOUS_STRING
    } else return m.asserts.fail("String value allows only " + m.html
            .SafeStyle.VALUE_ALLOWED_CHARS_ +
            " and simple functions, got: " + a), m.html.SafeStyle
        .INNOCUOUS_STRING;
...
m.html.SafeStyle.VALUE_RE_ = new RegExp("^" + m.html.SafeStyle
...
m.html.SafeStyle.ALLOWED_FUNCTIONS_ =
    ...
    .split(" ");
m.html.SafeStyle.FUNCTIONS_RE_ = new RegExp("\\b(" + m.html.SafeStyle
...
I.fromConstant = function (a) {
    ...
    (0, m.asserts.assert)(!(0, m.string.internal.contains)(a, "<"),
...
I.unwrap = function (a) {
    if (a instanceof I && a.constructor === I) return a
        .privateDoNotAccessOrElseSafeStyleSheetWrappedValue_;
    (0, m.asserts.fail)("expected object of type SafeStyleSheet, got '" +
        a + "' of type " + m.typeOf(a));
...
m.html.SafeHtml = function (a, c, d) {
    this.privateDoNotAccessOrElseSafeHtmlWrappedValue_ = d === m.html
...
m.html.SafeHtml.unwrapTrustedHTML = function (a) {
    ...
    m.asserts.fail("expected object of type SafeHtml, got '" + a +
        "' of type " + m.typeOf(a));
...
m.html.SafeHtml.htmlEscape = function (a) {
    ...
    var c = "object" == typeof a,
        d = null;
    c && a.implementsGoogI18nBidiDirectionalString && (d = a
.getDirection());
    return m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(m
        .string.internal.htmlEscape(c && a
...
m.html.SafeHtml.htmlEscapePreservingNewlines = function (a) {
    ...
    return m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(m
        .string.internal.newLineToBr(m.html.SafeHtml.unwrap(a)), a
        .getDirection())
};
m.html.SafeHtml.htmlEscapePreservingNewlinesAndSpaces = function (a) {
    ...
    a = m.html.SafeHtml.htmlEscape(a);
    return m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(m
        .string.internal.whitespaceEscape(m.html.SafeHtml.unwrap(a)), a
        .getDirection())
};
...
m.html.SafeHtml.comment = function (a) {
    return m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
        "\x3c!--" + m.string.internal.htmlEscape(a) + "--\x3e", null)
};
...
m.html.SafeHtml.NOT_ALLOWED_TAG_NAMES_ = m.object.createSet(m.dom.TagName
    .APPLET, m.dom.TagName.BASE, m.dom.TagName.EMBED, m.dom.TagName.IFRAME,
    m.dom.TagName.LINK, m.dom.TagName.MATH, m.dom.TagName.META, m.dom
    .TagName.OBJECT, m.dom.TagName.SCRIPT, m.dom.TagName.STYLE, m.dom
    .TagName.SVG, m.dom.TagName.TEMPLATE);
m.html.SafeHtml.create = function (a, c, d) {
    m.html.SafeHtml.verifyTagName(String(a));
    return m.html.SafeHtml
        .createSafeHtmlTagSecurityPrivateDoNotAccessOrElse(String(a), c, d)
};
m.html.SafeHtml.verifyTagName = function (a) {
    if (!m.html.SafeHtml.VALID_NAMES_IN_TAG_.test(a)) throw Error(m.html
        .SafeHtml.ENABLE_ERROR_MESSAGES ? "Invalid tag name <" + a +
        ">." : "");
    if (a.toUpperCase() in m.html.SafeHtml.NOT_ALLOWED_TAG_NAMES_)
    throw Error(m.html.SafeHtml.ENABLE_ERROR_MESSAGES ? "Tag name <" +
...
m.html.SafeHtml.createIframe = function (a, c, d, e) {
    ...
    a = m.html.SafeHtml.combineAttributes(f, {
        sandbox: ""
    }, d);
    return m.html.SafeHtml
        .createSafeHtmlTagSecurityPrivateDoNotAccessOrElse("iframe", a, e)
};
m.html.SafeHtml.createSandboxIframe = function (a, c, d, e) {
    if (!m.html.SafeHtml.canUseSandboxIframe()) throw Error(m.html.SafeHtml
...
m.html.SafeHtml.canUseSandboxIframe = function () {
    return m.global.HTMLIFrameElement && "sandbox" in m.global
        .HTMLIFrameElement.prototype
};
m.html.SafeHtml.createScriptSrc = function (a, c) {
    m.html.TrustedResourceUrl.unwrap(a);
    a = m.html.SafeHtml.combineAttributes({
        src: a
    }, {}, c);
    return m.html.SafeHtml
    ...
    for (var d in c)
        if (Object.prototype.hasOwnProperty.call(c, d)) {
            ...
            if ("language" == e || "src" == e || "text" == e || "type" == e)
                throw Error(m.html.SafeHtml.ENABLE_ERROR_MESSAGES ?
                    'Cannot set "' + e + '" attribute' : "");
        } d = "";
    a = B(a);
    for (e = 0; e < a.length; e++) d += G.unwrap(a[e]);
    a = m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(d, m
        .i18n.bidi.Dir.NEUTRAL);
    return m.html.SafeHtml
        .createSafeHtmlTagSecurityPrivateDoNotAccessOrElse("script", c, a)
};
m.html.SafeHtml.createStyle = function (a, c) {
    c = m.html.SafeHtml.combineAttributes({
        type: "text/css"
    }, {}, c);
    var d = "";
    a = B(a);
    ...
    a = m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(d, m
        .i18n.bidi.Dir.NEUTRAL);
    return m.html.SafeHtml
        .createSafeHtmlTagSecurityPrivateDoNotAccessOrElse("style", c, a)
};
m.html.SafeHtml.createMetaRefresh = function (a, c) {
    a = m.html.SafeUrl.unwrap(m.html.SafeUrl.sanitize(a));
    (m.labs.userAgent.browser.isIE() || m.labs.userAgent.browser
.isEdge()) && m.string.internal.contains(a, ";") && (a = "'" + a.replace(
        /'/g, "%27") + "'");
    return m.html.SafeHtml
...
m.html.SafeHtml.getAttrNameAndValue_ = function (a, c, d) {
    if (d instanceof m.string.Const) d = m.string.Const.unwrap(d);
        ...
        if (m.html.SafeHtml.SUPPORT_STYLE_ATTRIBUTE) d = m.html.SafeHtml
            .getStyleValue_(d);
        else throw Error(m.html.SafeHtml.ENABLE_ERROR_MESSAGES ?
            'Attribute "style" not supported.' : "");
    else {
        if (/^on/i.test(c)) throw Error(m.html.SafeHtml
            .ENABLE_ERROR_MESSAGES ? 'Attribute "' + c +
            '" requires goog.string.Const value, "' + d +
            '" given.' : "");
        if (c.toLowerCase() in m.html.SafeHtml.URL_ATTRIBUTES_)
            if (d instanceof m.html.TrustedResourceUrl) d = m.html
                .TrustedResourceUrl.unwrap(d);
            else if (d instanceof m.html.SafeUrl) d = m.html.SafeUrl.unwrap(
            d);
        else if ("string" === typeof d) d = m.html.SafeUrl.sanitize(d)
            .getTypedStringValue();
        else throw Error(m.html.SafeHtml.ENABLE_ERROR_MESSAGES ?
            'Attribute "' + c + '" on tag "' + a +
            '" requires goog.html.SafeUrl, goog.string.Const, or string, value "' +
            d + '" given.' : "");
    }
    d.implementsGoogStringTypedString && (d = d.getTypedStringValue());
    m.asserts.assert("string" === typeof d || "number" === typeof d,
        "String or number value expected, got " + typeof d +
        " with value: " + d);
    return c + '="' + m.string.internal.htmlEscape(String(d)) + '"'
};
m.html.SafeHtml.getStyleValue_ = function (a) {
    if (!m.isObject(a)) throw Error(m.html.SafeHtml.ENABLE_ERROR_MESSAGES ?
...
m.html.SafeHtml.join = function (a, c) {
    ...
    var d = a.getDirection(),
        e = [],
        f = function (g) {
            Array.isArray(g) ? w(g, f) : (g = m.html.SafeHtml.htmlEscape(g),
                e.push(m.html.SafeHtml.unwrap(g)), g = g.getDirection(),
                d == m.i18n.bidi.Dir.NEUTRAL ? d = g : g != m.i18n.bidi
                .Dir.NEUTRAL && d != g && (d = null))
        };
    w(c, f);
    return m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(e
        .join(m.html.SafeHtml.unwrap(a)), d)
};
m.html.SafeHtml.concat = function (a) {
    return m.html.SafeHtml.join(m.html.SafeHtml.EMPTY, Array.prototype.slice
        .call(arguments))
};
...
m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse = function (a,
c) {
    var d = m.html.trustedtypes.getPolicyPrivateDoNotAccessOrElse();
    a = d ? d.createHTML(a) : a;
    return new m.html.SafeHtml(a, c, m.html.SafeHtml
        .CONSTRUCTOR_TOKEN_PRIVATE_)
};
m.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse = function (a,
    c, d) {
    var e = null;
    var f = "<" + a + m.html.SafeHtml.stringifyAttributes(a, c);
    null == d ? d = [] : Array.isArray(d) || (d = [d]);
    m.dom.tags.isVoidTag(a.toLowerCase()) ? (m.asserts.assert(!d.length,
        "Void tag <" + a + "> does not allow content."), f += ">") : (
        e = m.html.SafeHtml.concat(d), f += ">" + m.html.SafeHtml
        .unwrap(e) + "</" + a + ">", e = e.getDirection());
    (a = c && c.dir) && (e = /^(ltr|rtl|auto)$/i.test(a) ? m.i18n.bidi.Dir
        .NEUTRAL : null);
    return m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(f,
        e)
};
    ...
    if (c)
        for (var e in c)
            if (Object.prototype.hasOwnProperty.call(c, e)) {
                ...
                var f = c[e];
                null != f && (d += " " + m.html.SafeHtml
                    .getAttrNameAndValue_(a, e, f))
            } return d
};
m.html.SafeHtml.combineAttributes = function (a, c, d) {
    var e = {},
        f;
    for (f in a) Object.prototype.hasOwnProperty.call(a, f) && (m.asserts
        .assert(f.toLowerCase() == f, "Must be lower case"), e[f] = a[f]
        );
    for (f in c) Object.prototype.hasOwnProperty.call(c, f) && (m.asserts
        .assert(f.toLowerCase() == f, "Must be lower case"), e[f] = c[f]
        );
    if (d)
        for (f in d)
            if (Object.prototype.hasOwnProperty.call(d, f)) {
                var g = f.toLowerCase();
                if (g in a) throw Error(m.html.SafeHtml
...
m.html.SafeHtml.DOCTYPE_HTML = m.html.SafeHtml
    .createSafeHtmlSecurityPrivateDoNotAccessOrElse("<!DOCTYPE html>", m.i18n
        .bidi.Dir.NEUTRAL);
m.html.SafeHtml.EMPTY = new m.html.SafeHtml(m.global.trustedTypes && m.global
    .trustedTypes.emptyHTML || "", m.i18n.bidi.Dir.NEUTRAL, m.html.SafeHtml
    .CONSTRUCTOR_TOKEN_PRIVATE_);
m.html.SafeHtml.BR = m.html.SafeHtml
    .createSafeHtmlSecurityPrivateDoNotAccessOrElse("<br>", m.i18n.bidi.Dir
        .NEUTRAL);
m.html.uncheckedconversions = {};
m.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract =
    function (a, c) {
        m.asserts.assertString(m.string.Const.unwrap(a),
            "must provide justification");
        m.asserts.assert(!m.string.internal.isEmptyOrWhitespace(m.string.Const
            .unwrap(a)), "must provide non-empty justification");
        return m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(c,
            null)
    };
...
m.html.uncheckedconversions
    .trustedResourceUrlFromStringKnownToSatisfyTypeContract = function (a, c) {
        m.asserts.assertString(m.string.Const.unwrap(a),
            "must provide justification");
        m.asserts.assert(!m.string.internal.isEmptyOrWhitespace(m.string.Const
            .unwrap(a)), "must provide non-empty justification");
...
m.dom.safe.isInnerHtmlCleanupRecursive_ = m.functions.cacheReturnValue(
    function () {
        ...
        a.innerHTML = m.html.SafeHtml.unwrapTrustedHTML(m.html.SafeHtml
            .EMPTY);
...
m.dom.safe.setInnerHtml = function (a, c) {
    if (m.asserts.ENABLE_ASSERTS && a.tagName && m.dom.safe
...
m.dom.safe.setInnerHtmlFromConstant = function (a, c) {
    m.dom.safe.setInnerHtml(a, m.html.uncheckedconversions
        .safeHtmlFromStringKnownToSatisfyTypeContract(m.string.Const
            .from("Constant HTML to be immediatelly used."), m.string
            .Const.unwrap(c)))
};
...
m.dom.safe.setFormElementAction = function (a, c) {
    c = c instanceof m.html.SafeUrl ? c : m.html.SafeUrl
        .sanitizeAssertUnchanged(c);
    m.dom.asserts.assertIsHTMLFormElement(a).action = m.html.SafeUrl.unwrap(
        c)
};
m.dom.safe.setButtonFormAction = function (a, c) {
    c = c instanceof m.html.SafeUrl ? c : m.html.SafeUrl
        .sanitizeAssertUnchanged(c);
    m.dom.asserts.assertIsHTMLButtonElement(a).formAction = m.html.SafeUrl
        .unwrap(c)
};
m.dom.safe.setInputFormAction = function (a, c) {
    c = c instanceof m.html.SafeUrl ? c : m.html.SafeUrl
        .sanitizeAssertUnchanged(c);
    m.dom.asserts.assertIsHTMLInputElement(a).formAction = m.html.SafeUrl
        .unwrap(c)
};
...
m.dom.safe.setLinkHrefAndRel = function (a, c, d) {
    ...
    a.rel = d;
    m.string.internal.caseInsensitiveContains(d, "stylesheet") ? (m.asserts
            .assert(c instanceof m.html.TrustedResourceUrl,
                'URL must be TrustedResourceUrl because "rel" contains "stylesheet"'
                ), a.href = m.html.TrustedResourceUrl.unwrap(c)) : a.href =
        c instanceof m.html.TrustedResourceUrl ? m.html.TrustedResourceUrl
        .unwrap(c) : c instanceof m.html.SafeUrl ? m.html.SafeUrl.unwrap(
        c) : m.html.SafeUrl.unwrap(m.html.SafeUrl.sanitizeAssertUnchanged(
            c))
};
...
m.dom.safe.setNonceForScriptElement_ = function (a) {
    var c = m.getScriptNonce(a.ownerDocument && a.ownerDocument
    .defaultView);
...
m.dom.safe.openInWindow = function (a, c, d, e, f) {
    a = a instanceof m.html.SafeUrl ? a : m.html.SafeUrl
        .sanitizeAssertUnchanged(a);
    c = c || m.global;
    d = d instanceof m.string.Const ? m.string.Const.unwrap(d) : d || "";
    return void 0 !== e || void 0 !== f ? c.open(m.html.SafeUrl.unwrap(a),
        d, e, f) : c.open(m.html.SafeUrl.unwrap(a), d)
};
...
m.dom.safe.createImageFromBlob = function (a) {
    ...
    m.dom.safe.setImageSrc(a, m.html.uncheckedconversions
        .safeUrlFromStringKnownToSatisfyTypeContract(m.string.Const
            .from("Image blob URL."), c));
    return a
};
...
m.string.caseInsensitiveStartsWith = m.string.internal
...
m.string.subs = function (a, c) {
    for (var d = a.split("%s"), e = "", f = Array.prototype.slice.call(
            arguments, 1); f.length && 1 < d.length;) e += d.shift() + f
        .shift();
    return e + d.join("%s")
};
...
m.string.numberAwareCompare_ = function (a, c, d) {
    ...
    if (!a) return -1;
    if (!c) return 1;
    for (var e = a.toLowerCase().match(d), f = c.toLowerCase().match(d), g =
            Math.min(e.length, f.length), h = 0; h < g; h++) {
        d = e[h];
        var l = f[h];
        if (d != l) return a = parseInt(d, 10), !isNaN(a) && (c = parseInt(
            l, 10), !isNaN(c) && a - c) ? a - c : d < l ? -1 : 1
    }
...
m.string.htmlEscape = function (a, c) {
    ...
    m.string.DETECT_DOUBLE_ESCAPING && (a = a.replace(m.string.E_RE_,
        "&#101;"));
    return a
};
m.string.E_RE_ = /e/g;
m.string.unescapeEntities = function (a) {
    return m.string.contains(a, "&") ? !m.string
        .FORCE_NON_DOM_HTML_UNESCAPING && "document" in m.global ? m.string
        .unescapeEntitiesUsingDom_(a) : m.string.unescapePureXmlEntities_(
        a) : a
};
m.string.unescapeEntitiesWithDocument = function (a, c) {
    return m.string.contains(a, "&") ? m.string.unescapeEntitiesUsingDom_(a,
        c) : a
};
m.string.unescapeEntitiesUsingDom_ = function (a, c) {
    ...
    var e = c ? c.createElement("div") : m.global.document.createElement(
        "div");
    return a.replace(m.string.HTML_ENTITY_PATTERN_, function (f, g) {
        var h = d[f];
        if (h) return h;
        "#" == g.charAt(0) && (g = Number("0" + g.substr(1)), isNaN(
            g) || (h = String.fromCharCode(g)));
        h || (m.dom.safe.setInnerHtml(e, m.html.uncheckedconversions
            .safeHtmlFromStringKnownToSatisfyTypeContract(m
                .string.Const.from("Single HTML entity."),
                f + " ")), h = e.firstChild.nodeValue.slice(
            0,
            -1));
        return d[f] = h
    })
    ...
    return a.replace(/&([^;]+);/g, function (c, d) {
        switch (d) {
            ...
            case "quot":
                return '"';
            default:
                return "#" != d.charAt(0) || (d = Number("0" + d
                        .substr(1)), isNaN(d)) ? c : String
                    .fromCharCode(d)
        }
    })
};
...
m.string.stripQuotes = function (a, c) {
    for (var d = c.length, e = 0; e < d; e++) {
        ...
        if (a.charAt(0) == f && a.charAt(a.length - 1) == f) return a
...
m.string.truncateMiddle = function (a, c, d, e) {
    d && (a = m.string.unescapeEntities(a));
    e && a.length > c ? (e > c && (e = c), a = a.substring(0, c - e) +
        "..." + a.substring(a.length - e)) : a.length > c && (e = Math
        .floor(c / 2), a = a.substring(0, e + c % 2) + "..." + a
...
m.string.quote = function (a) {
    ...
    for (var c = ['"'], d = 0; d < a.length; d++) {
        var e = a.charAt(d),
            f = e.charCodeAt(0);
        c[d + 1] = m.string.specialEscapeChars_[e] || (31 < f && 127 > f ?
            e : m.string.escapeChar(e))
    }
    c.push('"');
    return c.join("")
};
m.string.escapeString = function (a) {
    for (var c = [], d = 0; d < a.length; d++) c[d] = m.string.escapeChar(a
        .charAt(d));
    return c.join("")
};
m.string.escapeChar = function (a) {
    if (a in m.string.jsEscapeCache_) return m.string.jsEscapeCache_[a];
    if (a in m.string.specialEscapeChars_) return m.string.jsEscapeCache_[
        a] = m.string.specialEscapeChars_[a];
...
m.string.removeAt = function (a, c, d) {
    var e = a;
    0 <= c && c < a.length && 0 < d && (e = a.substr(0, c) + a.substr(c + d,
        a.length - c - d));
    return e
};
...
m.string.getRandomString = function () {
    return Math.floor(2147483648 * Math.random()).toString(36) + Math.abs(
        Math.floor(2147483648 * Math.random()) ^ m.now()).toString(36)
};
m.string.compareVersions = m.string.internal.compareVersions;
m.string.hashCode = function (a) {
    for (var c = 0, d = 0; d < a.length; ++d) c = 31 * c + a.charCodeAt(
        d) >>> 0;
    return c
};
...
m.string.editDistance = function (a, c) {
    ...
    for (f = 0; f < a.length; f++) {
        e[0] = f + 1;
        for (var g = 0; g < c.length; g++) e[g + 1] = Math.min(e[g] + 1, d[
            g + 1] + 1, d[g] + Number(a[f] != c[g]));
...
m.labs.userAgent.engine.isWebKit = function () {
    return m.labs.userAgent.util.matchUserAgentIgnoreCase("WebKit") && !m
        .labs.userAgent.engine.isEdge()
};
m.labs.userAgent.engine.isGecko = function () {
    return m.labs.userAgent.util.matchUserAgent("Gecko") && !m.labs
        .userAgent.engine.isWebKit() && !m.labs.userAgent.engine
    .isTrident() && !m.labs.userAgent.engine.isEdge()
};
m.labs.userAgent.engine.getVersion = function () {
    ...
    if (a) {
        ...
        if (c) return "Gecko" == c[0] ? m.labs.userAgent.engine
            .getVersionForKey_(a) : c[1];
        a = a[0];
        var d;
        if (a && (d = a[2]) && (d = /Trident\/([^\s;]+)/.exec(d))) return d[
            1]
    }
    return ""
};
...
m.labs.userAgent.engine.isVersionOrHigher = function (a) {
    return 0 <= m.string.compareVersions(m.labs.userAgent.engine
    .getVersion(), a)
};
...
m.labs.userAgent.platform.isIphone = function () {
    return m.labs.userAgent.util.matchUserAgent("iPhone") && !m.labs
        .userAgent.util.matchUserAgent("iPod") && !m.labs.userAgent.util
        .matchUserAgent("iPad")
};
...
m.labs.userAgent.platform.isIos = function () {
    return m.labs.userAgent.platform.isIphone() || m.labs.userAgent.platform
        .isIpad() || m.labs.userAgent.platform.isIpod()
};
...
m.labs.userAgent.platform.getVersion = function () {
    var a = m.labs.userAgent.util.getUserAgent(),
        c = "";
    m.labs.userAgent.platform.isWindows() ? (c =
            /Windows (?:NT|Phone) ([0-9.]+)/, c = (a = c.exec(a)) ? a[1] :
            "0.0") : m.labs.userAgent.platform.isIos() ? (c =
            /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/, c = (a = c.exec(a)) &&
            a[1].replace(/_/g, ".")) : m.labs.userAgent.platform
        .isMacintosh() ? (c = /Mac OS X ([0-9_.]+)/, c = (a = c.exec(a)) ?
            a[1].replace(/_/g, ".") : "10") : m.labs.userAgent.platform
        .isKaiOS() ? (c = /(?:KaiOS)\/(\S+)/i, c = (a = c.exec(a)) &&
            a[1]) : m.labs.userAgent.platform.isAndroid() ? (c =
            /Android\s+([^\);]+)(\)|;)/, c = (a = c.exec(a)) && a[1]) : m
        .labs.userAgent.platform.isChromeOS() && (c =
            /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/, c = (a = c.exec(a)) &&
            a[1]);
    return c || ""
};
m.labs.userAgent.platform.isVersionOrHigher = function (a) {
    return 0 <= m.string.compareVersions(m.labs.userAgent.platform
        .getVersion(), a)
};
m.reflect = {};
...
m.userAgent.BROWSER_KNOWN_ = m.userAgent.ASSUME_IE || m.userAgent.ASSUME_EDGE ||
    m.userAgent.ASSUME_GECKO || m.userAgent.ASSUME_MOBILE_WEBKIT || m.userAgent
    .ASSUME_WEBKIT || m.userAgent.ASSUME_OPERA;
...
m.userAgent.OPERA = m.userAgent.BROWSER_KNOWN_ ? m.userAgent.ASSUME_OPERA : m
    .labs.userAgent.browser.isOpera();
m.userAgent.IE = m.userAgent.BROWSER_KNOWN_ ? m.userAgent.ASSUME_IE : m.labs
    .userAgent.browser.isIE();
m.userAgent.EDGE = m.userAgent.BROWSER_KNOWN_ ? m.userAgent.ASSUME_EDGE : m.labs
    .userAgent.engine.isEdge();
m.userAgent.EDGE_OR_IE = m.userAgent.EDGE || m.userAgent.IE;
m.userAgent.GECKO = m.userAgent.BROWSER_KNOWN_ ? m.userAgent.ASSUME_GECKO : m
    .labs.userAgent.engine.isGecko();
m.userAgent.WEBKIT = m.userAgent.BROWSER_KNOWN_ ? m.userAgent.ASSUME_WEBKIT || m
    .userAgent.ASSUME_MOBILE_WEBKIT : m.labs.userAgent.engine.isWebKit();
m.userAgent.isMobile_ = function () {
    return m.userAgent.WEBKIT && m.labs.userAgent.util.matchUserAgent(
        "Mobile")
};
m.userAgent.MOBILE = m.userAgent.ASSUME_MOBILE_WEBKIT || m.userAgent
.isMobile_();
...
m.userAgent.PLATFORM_KNOWN_ = m.userAgent.ASSUME_MAC || m.userAgent
    .ASSUME_WINDOWS || m.userAgent.ASSUME_LINUX || m.userAgent.ASSUME_X11 || m
    .userAgent.ASSUME_ANDROID || m.userAgent.ASSUME_IPHONE || m.userAgent
    .ASSUME_IPAD || m.userAgent.ASSUME_IPOD;
m.userAgent.MAC = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_MAC : m.labs
    .userAgent.platform.isMacintosh();
m.userAgent.WINDOWS = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_WINDOWS :
    m.labs.userAgent.platform.isWindows();
m.userAgent.isLegacyLinux_ = function () {
    return m.labs.userAgent.platform.isLinux() || m.labs.userAgent.platform
        .isChromeOS()
};
m.userAgent.LINUX = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_LINUX : m
    .userAgent.isLegacyLinux_();
m.userAgent.isX11_ = function () {
    var a = m.userAgent.getNavigatorTyped();
    return !!a && m.string.contains(a.appVersion || "", "X11")
};
m.userAgent.X11 = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_X11 : m
    .userAgent.isX11_();
m.userAgent.ANDROID = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_ANDROID :
    m.labs.userAgent.platform.isAndroid();
m.userAgent.IPHONE = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_IPHONE : m
    .labs.userAgent.platform.isIphone();
m.userAgent.IPAD = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_IPAD : m
    .labs.userAgent.platform.isIpad();
m.userAgent.IPOD = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_IPOD : m
    .labs.userAgent.platform.isIpod();
m.userAgent.IOS = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_IPHONE || m
    .userAgent.ASSUME_IPAD || m.userAgent.ASSUME_IPOD : m.labs.userAgent
    .platform.isIos();
m.userAgent.KAIOS = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_KAIOS : m
    .labs.userAgent.platform.isKaiOS();
m.userAgent.determineVersion_ = function () {
    var a = "",
        c = m.userAgent.getVersionRegexResult_();
    c && (a = c ? c[1] : "");
    return m.userAgent.IE && (c = m.userAgent.getDocumentMode_(), null !=
        c && c > parseFloat(a)) ? String(c) : a
};
...
m.userAgent.isVersionOrHigher = function (a) {
    return m.userAgent.ASSUME_ANY_VERSION || m.reflect.cache(m.userAgent
...
m.debug.catchErrors = function (a, c, d) {
    ...
    var e = d.onerror,
        f = !!c;
    m.userAgent.WEBKIT && !m.userAgent.isVersionOrHigher("535.3") && (f = !
        f);
        ...
        g = function (h, l) {
            ...
            try {
                if (void 0 === h) d.push("undefined");
                    ...
                    m.hasUid(h) || e.push(h);
                    var p = m.getUid(h);
                    if (f[p]) d.push("*** reference loop detected (id=" +
                        p + ") ***");
                    else {
                        f[p] = !0;
                        d.push("{");
...
m.debug.exposeArray = function (a) {
    for (var c = [], d = 0; d < a.length; d++) Array.isArray(a[d]) ? c.push(
        m.debug.exposeArray(a[d])) : c.push(a[d]);
    return "[ " + c.join(", ") + " ]"
};
m.debug.normalizeErrorObject = function (a) {
    ...
    try {
        var f = a.fileName || a.filename || a.sourceURL || m.global
            .$googDebugFname || c
    } catch (h) {
        f = "Not available", d = !0
    }
...
m.debug.serializeErrorStack_ = function (a, c) {
    ...
    var d = a.stack || "";
    (a = a.cause) && !c[m.debug.serializeErrorAsKey_(a)] && (d +=
        "\nCaused by: ", a.stack && 0 == a.stack.indexOf(a
    .toString()) || (d += "string" === typeof a ? a : a.message + "\n"),
...
m.debug.enhanceError = function (a, c) {
    a instanceof Error || (a = Error(a), Error.captureStackTrace && Error
        .captureStackTrace(a, m.debug.enhanceError));
...
m.debug.enhanceErrorWithContext = function (a, c) {
    ...
    if (c)
        for (var d in c) m.debug.errorcontext.addErrorContext(a, d, c[d]);
    return a
};
m.debug.getStacktraceSimple = function (a) {
    ...
    a && e >= a ? c.push("[...reached max depth limit...]") : c.push(
        "[end]");
    return c.join("")
};
...
m.debug.getNativeStackTrace_ = function (a) {
    var c = Error();
    if (Error.captureStackTrace) return Error.captureStackTrace(c, a),
        String(c.stack);
    try {
        throw c;
    } catch (d) {
...
m.debug.getStacktrace = function (a) {
    var c;
    m.debug.FORCE_SLOPPY_STACKS || (c = m.debug.getNativeStackTrace_(a || m
        .debug.getStacktrace));
...
m.debug.freezeInternal_ = m.DEBUG && Object.freeze || function (a) {
    return a
};
...
m.debug.entryPointRegistry.register = function (a) {
    m.debug.entryPointRegistry.refList_[m.debug.entryPointRegistry.refList_
        .length] = a;
    if (m.debug.entryPointRegistry.monitorsMayExist_)
        for (var c = m.debug.entryPointRegistry.monitors_, d = 0; d < c
            .length; d++) a(m.bind(c[d].wrap, c[d]))
};
m.debug.entryPointRegistry.monitorAll = function (a) {
    m.debug.entryPointRegistry.monitorsMayExist_ = !0;
    for (var c = m.bind(a.wrap, a), d = 0; d < m.debug.entryPointRegistry
        .refList_.length; d++) m.debug.entryPointRegistry.refList_[d](c);
...
m.debug.entryPointRegistry.unmonitorAllIfPossible = function (a) {
    ...
    m.asserts.assert(a == c[c.length - 1],
        "Only the most recent monitor can be unwrapped.");
    a = m.bind(a.unwrap, a);
    for (var d = 0; d < m.debug.entryPointRegistry.refList_.length; d++) m
        .debug.entryPointRegistry.refList_[d](a);
    c.length--
};
...
m.Disposable = function () {
    m.Disposable.MONITORING_MODE != m.Disposable.MonitoringMode.OFF && (m
        .Disposable.instances_[m.getUid(this)] = this);
...
m.Disposable.getUndisposedObjects = function () {
    var a = [],
        c;
    for (c in m.Disposable.instances_) m.Disposable.instances_
        .hasOwnProperty(c) && a.push(m.Disposable.instances_[Number(c)]);
    return a
};
...
m.Disposable.prototype.dispose = function () {
    if (!this.disposed_ && (this.disposed_ = !0, this.disposeInternal(), m
            .Disposable.MONITORING_MODE != m.Disposable.MonitoringMode.OFF
            )) {
        var a = m.getUid(this);
        if (m.Disposable.MONITORING_MODE == m.Disposable.MonitoringMode
            .PERMANENT && !m.Disposable.instances_.hasOwnProperty(a))
        throw Error(this +
...
m.events.BrowserFeature = {
    HAS_W3C_BUTTON: !m.userAgent.IE || m.userAgent.isDocumentModeOrHigher(
        9),
    HAS_W3C_EVENT_SUPPORT: !m.userAgent.IE || m.userAgent
        .isDocumentModeOrHigher(9),
    SET_KEY_CODE_TO_PREVENT_DEFAULT: m.userAgent.IE && !m.userAgent
        .isVersionOrHigher("9"),
    HAS_NAVIGATOR_ONLINE_PROPERTY: !m.userAgent.WEBKIT || m.userAgent
        .isVersionOrHigher("528"),
    HAS_HTML5_NETWORK_EVENT_SUPPORT: m.userAgent.GECKO && m.userAgent
        .isVersionOrHigher("1.9b") || m.userAgent.IE && m.userAgent
        .isVersionOrHigher("8") || m.userAgent.OPERA && m.userAgent
        .isVersionOrHigher("9.5") ||
        m.userAgent.WEBKIT && m.userAgent.isVersionOrHigher("528"),
    HTML5_NETWORK_EVENTS_FIRE_ON_BODY: m.userAgent.GECKO && !m.userAgent
        .isVersionOrHigher("8") || m.userAgent.IE && !m.userAgent
        .isVersionOrHigher("9"),
    TOUCH_ENABLED: "ontouchstart" in m.global || !!(m.global.document &&
        document.documentElement && "ontouchstart" in document
        .documentElement) || !(!m.global.navigator || !m.global
        .navigator.maxTouchPoints && !m.global.navigator
        .msMaxTouchPoints),
    POINTER_EVENTS: "PointerEvent" in m.global,
    MSPOINTER_EVENTS: "MSPointerEvent" in
        m.global && !(!m.global.navigator || !m.global.navigator
            .msPointerEnabled),
    PASSIVE_EVENTS: function () {
        ...
        try {
            m.global.addEventListener("test", m.nullFunction, c), m
                .global.removeEventListener("test", m.nullFunction, c)
        } catch (d) {}
        return a
    }()
};
...
m.events.getVendorPrefixedName_ = function (a) {
    return m.userAgent.WEBKIT ? "webkit" + a : m.userAgent.OPERA ? "o" + a
...
m.events.EventType = {
    ...
    ANIMATIONITERATION: m.events.getVendorPrefixedName_(
        "AnimationIteration"),
...
m.events.getPointerFallbackEventName_ = function (a, c, d) {
    return m.events.BrowserFeature.POINTER_EVENTS ? a : m.events
        .BrowserFeature.MSPOINTER_EVENTS ? c : d
};
m.events.PointerFallbackEventType = {
    POINTERDOWN: m.events.getPointerFallbackEventName_(m.events.EventType
        .POINTERDOWN, m.events.EventType.MSPOINTERDOWN, m.events
        .EventType.MOUSEDOWN),
    POINTERUP: m.events.getPointerFallbackEventName_(m.events.EventType
        .POINTERUP, m.events.EventType.MSPOINTERUP, m.events.EventType
        .MOUSEUP),
    POINTERCANCEL: m.events.getPointerFallbackEventName_(m.events.EventType
        .POINTERCANCEL, m.events.EventType.MSPOINTERCANCEL, m.events
        .EventType.MOUSECANCEL),
    POINTERMOVE: m.events.getPointerFallbackEventName_(m.events.EventType
        .POINTERMOVE,
        m.events.EventType.MSPOINTERMOVE, m.events.EventType.MOUSEMOVE),
    POINTEROVER: m.events.getPointerFallbackEventName_(m.events.EventType
        .POINTEROVER, m.events.EventType.MSPOINTEROVER, m.events
        .EventType.MOUSEOVER),
    POINTEROUT: m.events.getPointerFallbackEventName_(m.events.EventType
        .POINTEROUT, m.events.EventType.MSPOINTEROUT, m.events.EventType
        .MOUSEOUT),
    POINTERENTER: m.events.getPointerFallbackEventName_(m.events.EventType
        .POINTERENTER, m.events.EventType.MSPOINTERENTER, m.events
        .EventType.MOUSEENTER),
    POINTERLEAVE: m.events.getPointerFallbackEventName_(m.events.EventType
        .POINTERLEAVE,
...
m.events.PointerTouchFallbackEventType = {
    ...
    POINTERMOVE: m.events.getPointerFallbackEventName_(m.events.EventType
        .POINTERMOVE,
        m.events.EventType.MSPOINTERMOVE, m.events.EventType.TOUCHMOVE)
};
...
m.events.BrowserEvent = function (a, c) {
    ...
    if (a) {
        var d = this.type = a.type,
            e = a.changedTouches && a.changedTouches.length ? a
            .changedTouches[0] : null;
        this.target = a.target ||
            a.srcElement;
        this.currentTarget = c;
        (c = a.relatedTarget) ? m.userAgent.GECKO && (m.reflect
                .canAccessProperty(c) || (c = null)): d == m.events
            .EventType.MOUSEOVER ? c = a.fromElement : d == m.events
            .EventType.MOUSEOUT && (c = a.toElement);
        this.relatedTarget = c;
        e ? (this.clientX = void 0 !== e.clientX ? e.clientX : e.pageX, this
                .clientY = void 0 !== e.clientY ? e.clientY : e.pageY, this
                .screenX = e.screenX || 0, this.screenY = e.screenY || 0) :
            (m.events.USE_LAYER_XY_AS_OFFSET_XY ? (this.offsetX = void 0 !==
                    a.layerX ? a.layerX : a.offsetX, this.offsetY =
                    void 0 !== a.layerY ?
                    a.layerY : a.offsetY) : (this.offsetX = m.userAgent
                    .WEBKIT || void 0 !== a.offsetX ? a.offsetX : a.layerX,
                    this.offsetY = m.userAgent.WEBKIT || void 0 !== a
        ...
        this.state = a.state;
        this.event_ = a;
        a.defaultPrevented && m.events.BrowserEvent.superClass_
            .preventDefault.call(this)
    }
};
m.inherits(m.events.BrowserEvent, m.events.Event);
m.events.BrowserEvent.MouseButton = {
    LEFT: 0,
    MIDDLE: 1,
    RIGHT: 2
};
...
m.events.BrowserEvent.prototype.preventDefault = function () {
    ...
    else if (a.returnValue = !1, m.events.BrowserFeature
...
m.events.BrowserEvent.getPointerType_ = function (a) {
    return "string" === typeof a.pointerType ? a.pointerType : m.events
        .BrowserEvent.IE_POINTER_TYPE_MAP[a.pointerType] || ""
};
m.events.Listenable = function () {};
m.events.Listenable.IMPLEMENTED_BY_PROP = "closure_listenable_" + (1E6 * Math
    .random() | 0);
...
m.events.ListenerMap.prototype.add = function (a, c, d, e, f) {
    ...
    var h = m.events.ListenerMap.findListenerIndex_(a, c, e, f); - 1 < h ? (
        c = a[h], d || (c.callOnce = !1)) : (c = new m.events.Listener(
        c, this.src, g, !!e, f), c.callOnce = d, a.push(c));
    return c
};
m.events.ListenerMap.prototype.remove = function (a, c, d, e) {
    ...
    return -1 < c ? (Ha(f[c]), A(f, c), 0 == f.length && (delete this
...
var Ia = function (a, c) {
    ...
    e && (Ha(c), 0 == a.listeners[d].length && (delete a.listeners[d], a
        .typeCount_--));
    return e
};
m.events.ListenerMap.prototype.removeAll = function (a) {
    ...
    for (d in this.listeners)
        if (!a || d == a) {
            for (var e = this.listeners[d], f = 0; f < e.length; f++) ++c,
                Ha(e[f]);
...
m.events.ListenerMap.findListenerIndex_ = function (a, c, d, e) {
    for (var f = 0; f < a.length; ++f) {
        var g = a[f];
        if (!g.removed && g.listener == c && g.capture == !!d && g
            .handler == e) return f
    }
    return -1
};
...
m.events.CaptureSimulationMode = {
    OFF_AND_FAIL: 0,
    OFF_AND_SILENT: 1,
    ON: 2
};
...
m.events.listen = function (a, c, d, e, f) {
    ...
    if (Array.isArray(c)) {
        for (var g = 0; g < c.length; g++) m.events.listen(a, c[g], d, e,
        f);
        return null
    }
    d = m.events.wrapListener(d);
    return m.events.Listenable.isImplementedBy(a) ? a.listen(c, d, m
        .isObject(e) ? !!e.capture : !!e, f) : m.events.listen_(a, c, d,
        !1, e, f)
};
m.events.listen_ = function (a, c, d, e, f, g) {
    ...
    if (h && !m.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
        if (m.events.CAPTURE_SIMULATION_MODE == m.events
            .CaptureSimulationMode.OFF_AND_FAIL) return m.asserts.fail(
    ...
    e.src = a;
    e.listener = d;
    if (a.addEventListener) m.events.BrowserFeature.PASSIVE_EVENTS || (f =
        h), void 0 === f && (f = !1), a.addEventListener(c.toString(),
        e, f);
    else if (a.attachEvent) a.attachEvent(m.events.getOnString_(c
    .toString()), e);
    else if (a.addListener && a.removeListener) m.asserts.assert(
            "change" === c, "MediaQueryList only has a change event"), a
        .addListener(e);
...
m.events.getProxy = function () {
    var a = m.events.handleBrowserEvent_,
        c = m.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT ? function (d) {
...
m.events.listenOnce = function (a, c, d, e, f) {
    if (Array.isArray(c)) {
        for (var g = 0; g < c.length; g++) m.events.listenOnce(a, c[g], d,
            e, f);
        return null
    }
    d = m.events.wrapListener(d);
    return m.events.Listenable.isImplementedBy(a) ? a.listenOnce(c, d, m
        .isObject(e) ? !!e.capture : !!e, f) : m.events.listen_(a, c, d,
        !0, e, f)
};
...
m.events.unlisten = function (a, c, d, e, f) {
    if (Array.isArray(c)) {
        for (var g = 0; g < c.length; g++) m.events.unlisten(a, c[g], d, e,
            f);
        return null
    }
    e = m.isObject(e) ? !!e.capture : !!e;
    d = m.events.wrapListener(d);
    if (m.events.Listenable.isImplementedBy(a)) return a.unlisten(c, d, e,
        f);
    if (!a) return !1;
...
m.events.unlistenByKey = function (a) {
    ...
    var d = a.type,
        e = a.proxy;
    c.removeEventListener ? c.removeEventListener(d, e, a.capture) : c
        .detachEvent ? c.detachEvent(m.events.getOnString_(d), e) : c
        .addListener && c.removeListener && c.removeListener(e);
    m.events.listenerCountEstimate_--;
    (d = m.events.getListenerMap_(c)) ? (Ia(d, a), 0 == d.typeCount_ && (d
        .src = null, c[m.events.LISTENER_MAP_PROP_] = null)) : Ha(a);
    return !0
};
...
m.events.removeAll = function (a, c) {
    if (!a) return 0;
    if (m.events.Listenable.isImplementedBy(a)) return a.removeAllListeners(
        c);
...
m.events.getListeners = function (a, c) {
    return m.events.Listenable.isImplementedBy(a) ? a.getListeners(c,
            void 0) : a ? (a = m.events.getListenerMap_(a)) ? a
        .getListeners(c, void 0) : [] : []
};
m.events.getListener = function (a, c, d, e, f) {
    d = m.events.wrapListener(d);
    e = !!e;
    return m.events.Listenable.isImplementedBy(a) ? a.getListener(c, d, e,
        f) : a ? (a = m.events.getListenerMap_(a)) ? a.getListener(c, d,
        e, f) : null : null
};
...
m.events.expose = function (a) {
    var c = [],
        d;
    for (d in a) a[d] && a[d].id ? c.push(d + " = " + a[d] + " (" + a[d]
        .id + ")") : c.push(d + " = " + a[d]);
    return c.join("\n")
};
m.events.getOnString_ = function (a) {
    return a in m.events.onStringMap_ ? m.events.onStringMap_[a] : m.events
        .onStringMap_[a] = m.events.onString_ + a
};
m.events.fireListeners = function (a, c, d) {
    return m.events.Listenable.isImplementedBy(a) ? a.fireListeners(c, d,
        void 0) : m.events.fireListeners_(a, c, d, void 0)
};
    ...
    if (a = m.events.getListenerMap_(a))
        if (c = a.listeners[c.toString()])
            for (c = c.concat(), a = 0; a < c.length; a++) {
                var g = c[a];
                g && g.capture == d && !g.removed && (g = m.events
                    .fireListener(g, e), f = f && !1 !== g)
            }
    return f
};
...
m.events.dispatchEvent = function (a, c) {
    m.asserts.assert(m.events.Listenable.isImplementedBy(a),
...
m.events.protectBrowserEventEntryPoint = function (a) {
    m.events.handleBrowserEvent_ = a.protectEntryPoint(m.events
        .handleBrowserEvent_)
};
    ...
    if (!m.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
        ...
        if (m.events.CAPTURE_SIMULATION_MODE == m.events
            ...
            if (!m.events.isMarkedIeEvent_(d)) {
                ...
                d = [];
                for (var f = c.currentTarget; f; f = f.parentNode) d.push(
                f);
                a = a.type;
                for (f = d.length - 1; !c.propagationStopped_ && 0 <=
                    f; f--) {
                    c.currentTarget = d[f];
                    var g = m.events.fireListeners_(d[f],
                        a, !0, c);
                    e = e && g
                }
                for (f = 0; !c.propagationStopped_ && f < d.length; f++) c
                    .currentTarget = d[f], g = m.events.fireListeners_(d[f],
                        a, !1, c), e = e && g
            }
...
m.events.LISTENER_WRAPPER_PROP_ = "__closure_events_fn_" + (1E9 * Math
.random() >>> 0);
m.events.wrapListener = function (a) {
    m.asserts.assert(a, "Listener can not be null.");
    if ("function" === typeof a) return a;
    m.asserts.assert(a.handleEvent,
        "An object listener must have handleEvent method.");
    a[m.events.LISTENER_WRAPPER_PROP_] || (a[m.events
        .LISTENER_WRAPPER_PROP_] = function (c) {
...
m.events.EventHandler.prototype.listen_ = function (a, c, d, e, f) {
    Array.isArray(c) || (c && (m.events.EventHandler.typeArray_[0] = c
        .toString()), c = m.events.EventHandler.typeArray_);
    for (var g = 0; g < c.length; g++) {
        var h = m.events.listen(a, c[g], d || this.handleEvent, e || !1,
...
var Ja = function (a, c, d, e, f, g) {
    if (Array.isArray(d))
        ...
        c = m.events.listenOnce(c, d, e || a.handleEvent, f, g || a
            .handler_ || a);
        if (!c) return a;
        a.keys_[c.key] = c
    }
...
b.unlisten = function (a, c, d, e, f) {
    ...
    else if (a = m.events.getListener(a, c, d || this.handleEvent, m
            .isObject(e) ? !!e.capture : !!e, f || this.handler_ || this)) m
...
b.removeAll = function () {
    m.object.forEach(this.keys_, function (a, c) {
...
b.dispatchEvent = function (a) {
    ...
    if (c) {
        var d = [];
        for (var e = 1; c; c = c.getParentEventTarget()) d.push(c), m
            .asserts.assert(++e < m.events.EventTarget.MAX_ANCESTORS_,
                "infinite loop")
    }
    return m.events.EventTarget.dispatchEventInternal_(this
        .actualEventTarget_, a, d)
};
b.disposeInternal = function () {
...
var Ka = function (a) {
    m.asserts.assert(a.eventTargetListeners_,
...
m.events.EventTarget.dispatchEventInternal_ = function (a, c, d) {
    ...
    c.propagationStopped_ || (h = c.currentTarget = a, f = h.fireListeners(
        e, !0, c) && f, c.propagationStopped_ || (f = h
        .fireListeners(e, !1, c) && f));
    if (d)
        for (g =
            0; !c.propagationStopped_ && g < d.length; g++) h = c
            .currentTarget = d[g], f = h.fireListeners(e, !1, c) && f;
    return f
};
...
m.math.longestCommonSubsequence = function (a, c, d, e) {
    ...
    for (var f = a.length, g = c.length, h = [], l = 0; l < f + 1; l++) h[
        l] = [], h[l][0] = 0;
    for (var n = 0; n < g + 1; n++) h[0][n] = 0;
    for (l = 1; l <= f; l++)
        for (n = 1; n <= g; n++) d(a[l - 1], c[n - 1]) ? h[l][n] = h[l - 1][
            n - 1
        ] + 1 : h[l][n] = Math.max(h[l - 1][n], h[l][n - 1]);
    var p = [];
    l = f;
    for (n = g; 0 < l && 0 < n;) d(a[l - 1], c[n - 1]) ? (p.unshift(e(l - 1,
        n - 1)), l--, n--) : h[l - 1][n] > h[l][n - 1] ? l-- : n--;
    return p
};
m.math.sum = function (a) {
    return fa(arguments, function (c, d) {
        return c + d
    }, 0)
};
...
m.math.sampleVariance = function (a) {
    ...
    return m.math.sum.apply(null, x(arguments, function (e) {
...
m.iter = {};
m.iter.StopIteration = "StopIteration" in m.global ? m.global.StopIteration : {
...
m.iter.range = function (a, c, d) {
    ...
    h.next = function () {
        if (0 < g && e >= f || 0 > g && e <= f) throw m.iter
            .StopIteration;
        var l = e;
        e += g;
        return l
...
m.iter.product = function (a) {
    if (ha(arguments, function (f) {
            return !f.length
        }) || !arguments.length) return new m.iter.Iterator;
    var c = new m.iter.Iterator,
        d = arguments,
        e = ya(0, d.length);
    c.next = function () {
        if (e) {
            for (var f = x(e, function (h, l) {
                    return d[l][h]
                }), g = e.length - 1; 0 <= g; g--) {
                m.asserts.assert(e);
                if (e[g] < d[g].length - 1) {
...
m.iter.GroupByIterator_.prototype.next = function () {
    ...
    for (var a = this.targetKey = this.currentKey, c = this.targetKey,
        d = []; this.currentKey == c;) {
...
m.iter.slice = function (a, c, d) {
    ...
    "number" === typeof d && (m.asserts.assert(m.math.isInt(d) && d >= c),
        a = m.iter.limit(a, d - c));
    return a
};
...
m.iter.permutations = function (a, c) {
    a = m.iter.toArray(a);
    c = m.iter.product.apply(void 0, ya(a, "number" === typeof c ? c : a
        .length));
...
m.structs.Map = function (a, c) {
    ...
    if (1 < d) {
        ...
        for (var e = 0; e < d; e += 2) this.set(arguments[e], arguments[e +
            1])
...
b.getValues = function () {
    K(this);
    for (var a = [], c = 0; c < this.keys_.length; c++) a.push(this.map_[
        this.keys_[c]]);
    return a
};
b.getKeys = function () {
...
m.structs.Map.prototype.remove = function (a) {
    return m.structs.Map.hasKey_(this.map_, a) ? (delete this.map_[a], this
...
var K = function (a) {
    ...
    if (a.count_ != a.keys_.length) {
        var f = {};
        for (d = c = 0; c < a.keys_.length;) e = a.keys_[c], m.structs.Map
            .hasKey_(f, e) || (a.keys_[d++] = e, f[e] = 1), c++;
        a.keys_.length = d
    }
};
b = m.structs.Map.prototype;
...
b.set = function (a, c) {
    m.structs.Map.hasKey_(this.map_, a) || (this.count_++, this.keys_.push(
        a), this.version_++);
    this.map_[a] = c
};
b.addAll = function (a) {
    if (a instanceof m.structs.Map)
        for (var c = a.getKeys(), d = 0; d < c.length; d++) this.set(c[d], a
            .get(c[d]));
    else
...
b.set = function (a, c) {
    var d = Ma(this, a);
    d ? d.value = c : (d = new m.structs.LinkedMap.Node_(a, c), this.map_
        .set(a, d), La(this, d))
};
b.peek = function () {
...
b.forEach = function (a, c) {
    for (var d = this.head_.next; d != this.head_; d = d.next) a.call(c, d
        .value, d.key, this)
};
b.map = function (a, c) {
    for (var d = [], e = this.head_.next; e != this.head_; e = e.next) d
        .push(a.call(c, e.value, e.key, this));
    return d
};
b.some = function (a, c) {
...
var La = function (a, c) {
        a.cache_ ? (c.next = a.head_.next, c.prev = a.head_, a.head_.next = c, c
            .next.prev = c) : (c.prev = a.head_.prev, c.next = a.head_, a
            .head_.prev = c, c.prev.next = c);
...
m.structs.getCount = function (a) {
    return a.getCount && "function" == typeof a.getCount ? a.getCount() : m
        .isArrayLike(a) || "string" === typeof a ? a.length : m.object
        .getCount(a)
};
...
m.structs.contains = function (a, c) {
    return a.contains && "function" == typeof a.contains ? a.contains(c) : a
        .containsValue && "function" == typeof a.containsValue ? a
        .containsValue(c) : m.isArrayLike(a) || "string" === typeof a ? y(a,
            c) : m.object.containsValue(a, c)
};
m.structs.isEmpty = function (a) {
    return a.isEmpty && "function" == typeof a.isEmpty ? a.isEmpty() : m
        .isArrayLike(a) || "string" === typeof a ? z(a) : m.object.isEmpty(
            a)
};
m.structs.clear = function (a) {
    a.clear && "function" == typeof a.clear ? a.clear() : m.isArrayLike(a) ?
        ma(a) : m.object.clear(a)
};
m.structs.forEach = function (a, c, d) {
    if (a.forEach && "function" == typeof a.forEach) a.forEach(c, d);
        ...
        for (var e = m.structs.getKeys(a), f = m.structs.getValues(a), g = f
                .length, h = 0; h < g; h++) c.call(d, f[h], e && e[h], a)
};
m.structs.filter = function (a, c, d) {
    ...
    if (e) {
        var h = {};
        for (var l = 0; l < g; l++) c.call(d, f[l], e[l], a) && (h[e[l]] =
            f[l])
    } else
        for (h = [], l = 0; l < g; l++) c.call(d, f[l], void 0, a) && h
            .push(f[l]);
    return h
};
m.structs.map = function (a, c, d) {
    ...
    if (e) {
        ...
        for (h = [], l = 0; l < g; l++) h[l] = c.call(d, f[l], void 0, a);
    return h
};
...
m.uri.utils.split = function (a) {
    ...
    m.uri.utils.urlPackageSupportLoggingHandler_ && 0 <= ["http", "https",
            "ws", "wss", "ftp"
        ].indexOf(c[m.uri.utils.ComponentIndex.SCHEME]) && m.uri.utils
...
m.uri.utils.getScheme = function (a) {
    return m.uri.utils.getComponentByIndex_(m.uri.utils.ComponentIndex
        .SCHEME, a)
};
m.uri.utils.getEffectiveScheme = function (a) {
    a = m.uri.utils.getScheme(a);
    !a && m.global.self && m.global.self.location && (a = m.global.self
...
m.uri.utils.getPort = function () {
    return Number(m.uri.utils.getComponentByIndex_(m.uri.utils
        .ComponentIndex.PORT, void 0)) || null
};
m.uri.utils.getPathEncoded = function () {
    return m.uri.utils.getComponentByIndex_(m.uri.utils.ComponentIndex.PATH,
        void 0)
};
...
m.uri.utils.getHost = function (a) {
    ...
    return m.uri.utils.buildFromEncodedParts(a[m.uri.utils.ComponentIndex
        .SCHEME], a[m.uri.utils.ComponentIndex.USER_INFO], a[m.uri
        .utils.ComponentIndex.DOMAIN], a[m.uri.utils.ComponentIndex
        .PORT])
};
m.uri.utils.getOrigin = function (a) {
    a = m.uri.utils.split(a);
    return m.uri.utils.buildFromEncodedParts(a[m.uri.utils.ComponentIndex
        .SCHEME], null, a[m.uri.utils.ComponentIndex.DOMAIN], a[m
        .uri.utils.ComponentIndex.PORT])
};
m.uri.utils.getPathAndAfter = function (a) {
    a = m.uri.utils.split(a);
    return m.uri.utils.buildFromEncodedParts(null, null, null, null, a[m.uri
        .utils.ComponentIndex.PATH], a[m.uri.utils.ComponentIndex
        .QUERY_DATA], a[m.uri.utils.ComponentIndex.FRAGMENT])
};
...
m.uri.utils.haveSameDomain = function (a, c) {
    ...
    return a[m.uri.utils.ComponentIndex.DOMAIN] == c[m.uri.utils
            .ComponentIndex.DOMAIN] && a[m.uri.utils.ComponentIndex
        .SCHEME] == c[m.uri.utils.ComponentIndex.SCHEME] && a[m.uri.utils
            .ComponentIndex.PORT] == c[m.uri.utils.ComponentIndex.PORT]
};
m.uri.utils.assertNoFragmentsOrQueries_ = function (a) {
    m.asserts.assert(0 > a.indexOf("#") && 0 > a.indexOf("?"),
...
m.uri.utils.appendKeyValuePairs_ = function (a, c, d) {
    ...
    if (Array.isArray(c)) {
        ...
        for (var e = 0; e < c.length; e++) m.uri.utils.appendKeyValuePairs_(
            a, String(c[e]), d)
    } else null != c && d.push(a + ("" === c ? "" : "=" + m.string
        .urlEncode(c)))
};
m.uri.utils.buildQueryData = function (a, c) {
    m.asserts.assert(0 == Math.max(a.length - (c || 0), 0) % 2,
        "goog.uri.utils: Key/value lists must be even in length.");
    var d = [];
    for (c = c || 0; c < a.length; c += 2) m.uri.utils.appendKeyValuePairs_(
        a[c], a[c + 1], d);
    return d.join("&")
};
...
m.uri.utils.appendParams = function (a, c) {
    var d = 2 == arguments.length ? m.uri.utils.buildQueryData(arguments[1],
        0) : m.uri.utils.buildQueryData(arguments, 1);
...
m.uri.utils.findParam_ = function (a, c, d, e) {
    for (var f = d.length; 0 <= (c = a.indexOf(d, c)) && c < e;) {
        ...
        if (g == m.uri.utils.CharCode_.AMPERSAND || g == m.uri.utils
            .CharCode_.QUESTION)
            if (g = a.charCodeAt(c + f), !g || g == m.uri.utils.CharCode_
                .EQUAL || g == m.uri.utils.CharCode_.AMPERSAND || g == m.uri
                .utils.CharCode_.HASH) return c;
        c += f + 1
    }
    return -1
};
...
m.uri.utils.hasParam = function (a, c) {
    return 0 <= m.uri.utils.findParam_(a, 0, c, a.search(m.uri.utils
        .hashOrEndRe_))
};
...
m.uri.utils.getParamValues = function (a, c) {
    for (var d = a.search(m.uri.utils.hashOrEndRe_), e = 0, f, g = []; 0 <=
        (f = m.uri.utils.findParam_(a, e, c, d));) {
        e = a.indexOf("&", f);
        if (0 > e || e > d) e = d;
        f += c.length + 1;
...
m.uri.utils.removeParam = function (a, c) {
    for (var d = a.search(m.uri.utils.hashOrEndRe_), e = 0, f, g = []; 0 <=
        (f = m.uri.utils.findParam_(a, e, c, d));) g.push(a.substring(e,
        f)), e = Math.min(a.indexOf("&", f) + 1 || d, d);
    g.push(a.substr(e));
...
m.uri.utils.setParamsFromMap = function (a, c) {
    ...
    var d = a[1],
        e = [];
    d && d.split("&").forEach(function (f) {
        var g = f.indexOf("=");
        c.hasOwnProperty(0 <= g ? f.substr(0, g) : f) || e.push(f)
    });
    a[1] = m.uri.utils.appendQueryData_(e.join("&"), m.uri.utils
        .buildQueryDataFromMap(c));
    return m.uri.utils.joinQueryData_(a)
};
...
m.uri.utils.StandardQueryParam = {
    RANDOM: "zx"
};
...
m.Uri = function (a, c) {
    ...
    var d;
    a instanceof m.Uri ? (this.ignoreCase_ = void 0 !== c ? c : a
        .ignoreCase_, Pa(this, a.getScheme()), Qa(this, a
    .getUserInfo()), Ra(this, a.getDomain()), Sa(this, a.getPort()),
        this.setPath(a.getPath()), N(this, a.getQueryData().clone()),
        Ta(this, a.getFragment())) : a && (d = m.uri.utils.split(String(
        a))) ? (this.ignoreCase_ = !!c, Pa(this, d[m.uri.utils
            .ComponentIndex.SCHEME] || "", !0),
        Qa(this, d[m.uri.utils.ComponentIndex.USER_INFO] || "", !0), Ra(
            this, d[m.uri.utils.ComponentIndex.DOMAIN] || "", !0), Sa(
            this, d[m.uri.utils.ComponentIndex.PORT]), this.setPath(d[m
            .uri.utils.ComponentIndex.PATH] || "", !0), N(this, d[m.uri
            .utils.ComponentIndex.QUERY_DATA] || "", !0), Ta(this, d[m
            .uri.utils.ComponentIndex.FRAGMENT] || "", !0)) : (this
        .ignoreCase_ = !!c, this.queryData_ = new m.Uri.QueryData(null,
            this.ignoreCase_))
};
...
m.Uri.prototype.toString = function () {
    var a = [],
        c = this.getScheme();
    c && a.push(m.Uri.encodeSpecialChars_(c, m.Uri
        .reDisallowedInSchemeOrUserInfo_, !0), ":");
    var d = this.getDomain();
    if (d || "file" == c) a.push("//"), (c = this.getUserInfo()) && a.push(m
            .Uri.encodeSpecialChars_(c, m.Uri
                .reDisallowedInSchemeOrUserInfo_, !0), "@"), a.push(m.Uri
            .removeDoubleEncoding_(m.string.urlEncode(d))), d = this
        .getPort(), null != d && a.push(":", String(d));
    if (d = this.getPath()) this.domain_ && "/" != d.charAt(0) && a.push(
        "/"), a.push(m.Uri.encodeSpecialChars_(d,
        "/" == d.charAt(0) ? m.Uri.reDisallowedInAbsolutePath_ : m
        .Uri.reDisallowedInRelativePath_, !0));
    (d = this.queryData_.toString()) && a.push("?", d);
    (d = this.getFragment()) && a.push("#", m.Uri.encodeSpecialChars_(d, m
    ...
    if (d) Sa(c, a.getPort());
        ...
        if ("/" != e.charAt(0))
            if (this.domain_ && !this.path_) e = "/" + e;
                ...
                var f = c.getPath().lastIndexOf("/"); - 1 != f && (e = c
                    .getPath().substr(0, f + 1) + e)
...
var N = function (a, c, d) {
    O(a);
    c instanceof m.Uri.QueryData ? (a.queryData_ = c, a.queryData_
        .setIgnoreCase(a.ignoreCase_)) : (d || (c = m.Uri
            .encodeSpecialChars_(c, m.Uri.reDisallowedInQuery_)), a
        .queryData_ = new m.Uri.QueryData(c, a.ignoreCase_))
};
...
m.Uri.removeDotSegments = function (a) {
    ...
    if (m.string.contains(a, "./") || m.string.contains(a, "/.")) {
        ...
        for (var d = [], e = 0; e < a.length;) {
            var f = a[e++];
            "." == f ? c && e == a.length && d.push("") : ".." == f ? ((1 <
                    d.length || 1 == d.length && "" != d[0]) && d.pop(),
                c && e == a.length && d.push("")) : (d.push(f), c = !0)
        }
        return d.join("/")
    }
    return a
...
m.Uri.haveSameDomain = function (a, c) {
    ...
    c = m.uri.utils.split(c);
    return a[m.uri.utils.ComponentIndex.DOMAIN] == c[m.uri.utils
            .ComponentIndex.DOMAIN] && a[m.uri.utils.ComponentIndex.PORT] ==
        c[m.uri.utils.ComponentIndex.PORT]
};
...
var Q = function (a) {
    a.keyMap_ || (a.keyMap_ = new m.structs.Map, a.count_ = 0, a
        .encodedQuery_ && m.uri.utils.parseQueryData(a.encodedQuery_,
            function (c, d) {
...
m.Uri.QueryData.createFromKeysValues = function (a, c, d) {
    if (a.length != c.length) throw Error(
...
b.remove = function (a) {
    ...
    return this.keyMap_.containsKey(a) ? (this.encodedQuery_ = null, this
        .count_ = m.asserts.assertNumber(this.count_) - this.keyMap_
...
b.getKeys = function () {
    Q(this);
    for (var a = this.keyMap_.getValues(), c = this.keyMap_.getKeys(),
        d = [], e = 0; e < c.length; e++)
...
b.getValues = function (a) {
    Q(this);
    var c = [];
    if ("string" === typeof a) this.containsKey(a) && (c = B(c, this.keyMap_
        .get(R(this, a))));
    else {
...
b.set = function (a, c) {
    ...
    this.encodedQuery_ = null;
    a = R(this, a);
    this.containsKey(a) && (this.count_ = m.asserts.assertNumber(this
...
var Ua = function (a, c, d) {
    a.remove(c);
    0 < d.length && (a.encodedQuery_ = null, a.keyMap_.set(R(a, c), C(d)), a
        .count_ = m.asserts.assertNumber(a.count_) + d.length)
};
...
m.Uri.QueryData.prototype.setIgnoreCase = function (a) {
    a && !this.ignoreCase_ && (Q(this), this.encodedQuery_ = null, this
        .keyMap_.forEach(function (c, d) {
            var e = d.toLowerCase();
...
m.Uri.QueryData.prototype.extend = function (a) {
    for (var c = 0; c < arguments.length; c++) m.structs.forEach(arguments[
        c], function (d, e) {
        this.add(e, d)
    }, this)
};
            ...
            lb = function (F) {
                if (F) {
                    ...
                    t.onreadystatechange =
                        function () {
                            4 == t.readyState && (401 == t.status && F ? chrome
                                .identity.removeCachedAuthToken({
                                    token: F
                                }, function () {
                                    h ? Xa(a, e, d, e, f, g, !1, l, n,
                                        p) : (console.log(t), jb(t
                                            .status, t.responseText
                                            ))
                                }) : (console.log(t), jb(t.status, t
                                    .responseText)))
                        };
                    t.send(v)
                } else g(Va.TOKEN_MISSING_ERROR)
            };
        p ? lb(p) : chrome.identity.getAuthToken({
            interactive: n || !1
        }, lb)
    };
...
var Ya = function (a, c, d, e, f, g, h, l) {
    ...
    Xa(a, l.toString(), JSON.stringify(c), "POST", function (n) {
        e(n.jwt, n.paymentData, n.signature)
    }, f, !0, "application/json", void 0, g)
};
S.Environment = {
...
m.dom.BrowserFeature.OFFSCREEN_CANVAS_2D = !m.dom.BrowserFeature
    .ASSUME_NO_OFFSCREEN_CANVAS && (m.dom.BrowserFeature
        .ASSUME_OFFSCREEN_CANVAS || m.dom.BrowserFeature
        .detectOffscreenCanvas_());
m.dom.BrowserFeature.CAN_ADD_NAME_OR_TYPE_ATTRIBUTES = !m.userAgent.IE || m
    .userAgent.isDocumentModeOrHigher(9);
m.dom.BrowserFeature.CAN_USE_CHILDREN_ATTRIBUTE = !m.userAgent.GECKO && !m
    .userAgent.IE || m.userAgent.IE && m.userAgent.isDocumentModeOrHigher(9) ||
    m.userAgent.GECKO && m.userAgent.isVersionOrHigher("1.9.1");
m.dom.BrowserFeature.CAN_USE_INNER_TEXT = m.userAgent.IE && !m.userAgent
    .isVersionOrHigher("9");
m.dom.BrowserFeature.CAN_USE_PARENT_ELEMENT_PROPERTY = m.userAgent.IE || m
    .userAgent.OPERA || m.userAgent.WEBKIT;
m.dom.BrowserFeature.INNER_HTML_NEEDS_SCOPED_ELEMENT = m.userAgent.IE;
m.dom.BrowserFeature.LEGACY_IE_RANGES = m.userAgent.IE && !m.userAgent
    .isDocumentModeOrHigher(9);
...
m.DEBUG && (m.math.Coordinate.prototype.toString = function () {
    return "(" + this.x + ", " + this.y + ")"
});
m.math.Coordinate.prototype.equals = function (a) {
    return a instanceof m.math.Coordinate && m.math.Coordinate.equals(this,
        a)
};
...
b.translate = function (a, c) {
    a instanceof m.math.Coordinate ? (this.x += a.x, this.y += a.y) : (this
        .x += Number(a), "number" === typeof c && (this.y += c));
    return this
};
...
m.math.Size.equals = function (a, c) {
    return a == c ? !0 : a && c ? a.width == c.width && a.height == c
        .height : !1
};
m.math.Size.prototype.clone = function () {
    return new m.math.Size(this.width, this.height)
};
m.DEBUG && (m.math.Size.prototype.toString = function () {
...
m.dom.COMPAT_MODE_KNOWN_ = m.dom.ASSUME_QUIRKS_MODE || m.dom
    .ASSUME_STANDARDS_MODE;
m.dom.getDomHelper = function (a) {
    return a ? new m.dom.DomHelper(m.dom.getOwnerDocument(a)) : m.dom
        .defaultDomHelper_ || (m.dom.defaultDomHelper_ = new m.dom
            .DomHelper)
};
...
m.dom.getElementsByClass = function (a, c) {
    var d = c || document;
    return m.dom.canUseQuerySelector_(d) ? d.querySelectorAll("." + a) : m
        .dom.getElementsByTagNameAndClass_(document, "*", a, c)
};
m.dom.getElementByClass = function (a, c) {
    var d = c || document;
    return (d.getElementsByClassName ? d.getElementsByClassName(a)[0] : m
        .dom.getElementByTagNameAndClass_(document, "*", a, c)) || null
};
...
m.dom.getElementsByTagNameAndClass_ = function (a, c, d, e) {
    ...
    if (m.dom.canUseQuerySelector_(a) && (c || d)) return a
        .querySelectorAll(c + (d ? "." + d : ""));
    if (d && a.getElementsByClassName) {
        a = a.getElementsByClassName(d);
        if (c) {
            e = {};
            for (var f = 0, g = 0, h; h = a[g]; g++) c == h.nodeName && (e[
                f++] = h);
            e.length = f;
            return e
        }
    ...
    if (d) {
        e = {};
        for (g = f = 0; h = a[g]; g++) c = h.className, "function" ==
            typeof c.split && y(c.split(/\s+/), d) && (e[f++] = h);
        e.length = f;
        return e
    }
    return a
...
m.dom.getElementByTagNameAndClass_ = function (a, c, d, e) {
    ...
    return m.dom.canUseQuerySelector_(f) && (g || d) ? f.querySelector(g + (
        d ? "." + d : "")) : m.dom.getElementsByTagNameAndClass_(a, c,
        d, e)[0] || null
};
...
m.dom.setProperties = function (a, c) {
    m.object.forEach(c, function (d, e) {
        d && "object" == typeof d && d
            .implementsGoogStringTypedString && (d = d
                .getTypedStringValue());
        "style" == e ? a.style.cssText = d : "class" == e ? a
            .className = d : "for" == e ? a.htmlFor = d : m.dom
            .DIRECT_ATTRIBUTE_MAP_.hasOwnProperty(e) ? a
            .setAttribute(m.dom.DIRECT_ATTRIBUTE_MAP_[e], d) : m
            .string.startsWith(e, "aria-") || m.string.startsWith(e,
                "data-") ? a.setAttribute(e, d) : a[e] = d
    })
};
...
m.dom.getDocumentHeight_ = function (a) {
    ...
    if (c) {
        ...
        if (m.dom.isCss1CompatMode_(c) && e.scrollHeight) d = e
...
m.dom.getPageScroll = function (a) {
    return m.dom.getDomHelper((a || m.global || window).document)
        .getDocumentScroll()
};
...
m.dom.getDocumentScroll_ = function (a) {
    ...
    return m.userAgent.IE && m.userAgent.isVersionOrHigher("10") && a
        .pageYOffset != c.scrollTop ? new m.math.Coordinate(c.scrollLeft, c
            .scrollTop) : new m.math.Coordinate(a.pageXOffset || c
            .scrollLeft, a.pageYOffset || c.scrollTop)
};
...
m.dom.getDocumentScrollElement_ = function (a) {
    return a.scrollingElement ? a.scrollingElement : !m.userAgent.WEBKIT &&
        m.dom.isCss1CompatMode_(a) ? a.documentElement : a.body || a
        .documentElement
};
...
m.dom.createDom_ = function (a, c) {
    var d = String(c[0]),
        e = c[1];
    if (!m.dom.BrowserFeature.CAN_ADD_NAME_OR_TYPE_ATTRIBUTES && e && (e
            .name || e.type)) {
        d = ["<", d];
    ...
    e && ("string" === typeof e ? d.className = e : Array.isArray(e) ? d
        .className = e.join(" ") : m.dom.setProperties(d, e));
    2 < c.length && m.dom.append_(a, d,
        c, 2);
    return d
};
m.dom.append_ = function (a, c, d, e) {
    ...
    for (; e < d.length; e++) {
        var g = d[e];
        m.isArrayLike(g) && !m.dom.isNodeLike(g) ? w(m.dom.isNodeList(g) ?
            C(g) : g, f) : f(g)
    }
};
...
m.dom.createTable_ = function (a, c, d, e) {
    for (var f = m.dom.createElement_(a, m.dom.TagName.TABLE), g = f
            .appendChild(m.dom.createElement_(a, m.dom.TagName.TBODY)), h =
            0; h < c; h++) {
        for (var l = m.dom.createElement_(a, m.dom.TagName.TR), n = 0; n <
            d; n++) {
...
m.dom.constHtmlToNode = function (a) {
    ...
    c = m.html.uncheckedconversions
        .safeHtmlFromStringKnownToSatisfyTypeContract(m.string.Const.from(
...
m.dom.safeHtmlToNode_ = function (a, c) {
    ...
    m.dom.BrowserFeature.INNER_HTML_NEEDS_SCOPED_ELEMENT ? (m.dom.safe
            .setInnerHtml(d, m.html.SafeHtml.concat(m.html.SafeHtml.BR, c)),
            d.removeChild(m.asserts.assert(d.firstChild))) : m.dom.safe
        .setInnerHtml(d, c);
    return m.dom.childrenToNode_(a, d)
};
m.dom.childrenToNode_ = function (a, c) {
    if (1 == c.childNodes.length) return c.removeChild(m.asserts.assert(c
        .firstChild));
    for (a = a.createDocumentFragment(); c.firstChild;) a.appendChild(c
        .firstChild);
    return a
};
...
m.dom.isCss1CompatMode_ = function (a) {
    return m.dom.COMPAT_MODE_KNOWN_ ? m.dom.ASSUME_STANDARDS_MODE :
...
m.dom.appendChild = function (a, c) {
    m.asserts.assert(null != a && null != c,
...
m.dom.getChildren = function (a) {
    return m.dom.BrowserFeature.CAN_USE_CHILDREN_ATTRIBUTE && void 0 != a
        .children ? a.children : ea(a.childNodes, function (c) {
            return c.nodeType == m.dom.NodeType.ELEMENT
        })
};
m.dom.getFirstElementChild = function (a) {
    return void 0 !== a.firstElementChild ? a.firstElementChild : m.dom
        .getNextElementNode_(a.firstChild, !0)
};
m.dom.getLastElementChild = function (a) {
    return void 0 !== a.lastElementChild ? a.lastElementChild : m.dom
        .getNextElementNode_(a.lastChild, !1)
};
m.dom.getNextElementSibling = function (a) {
    return void 0 !== a.nextElementSibling ? a.nextElementSibling : m.dom
...
m.dom.getNextElementNode_ = function (a, c) {
    for (; a && a.nodeType != m.dom.NodeType.ELEMENT;) a = c ? a
...
m.dom.getParentElement = function (a) {
    var c;
    if (m.dom.BrowserFeature.CAN_USE_PARENT_ELEMENT_PROPERTY && !(m
            .userAgent.IE && m.userAgent.isVersionOrHigher("9") && !m
            .userAgent.isVersionOrHigher("10") && m.global.SVGElement &&
            a instanceof m.global.SVGElement) && (c = a.parentElement))
        return c;
    c = a.parentNode;
...
m.dom.contains = function (a, c) {
    if (!a || !c) return !1;
    if (a.contains && c.nodeType == m.dom.NodeType.ELEMENT) return a == c ||
        a.contains(c);
    if ("undefined" != typeof a.compareDocumentPosition) return a == c || !!
...
m.dom.compareNodeOrder = function (a, c) {
    if (a == c) return 0;
    if (a.compareDocumentPosition) return a.compareDocumentPosition(c) & 2 ?
        1 : -1;
    ...
    if ("sourceIndex" in a || a.parentNode && "sourceIndex" in a
        ...
        var f = a.parentNode,
            g = c.parentNode;
        return f == g ? m.dom.compareSiblingOrder_(a, c) : !d && m.dom
            .contains(f, c) ? -1 * m.dom.compareParentsDescendantNodeIe_(a,
                c) : !e && m.dom.contains(g, a) ? m.dom
            .compareParentsDescendantNodeIe_(c, a) : (d ? a.sourceIndex : f
                .sourceIndex) - (e ? c.sourceIndex : g.sourceIndex)
    }
...
m.dom.findCommonAncestor = function (a) {
    ...
    var e = [],
        f = Infinity;
    for (c = 0; c < d; c++) {
        for (var g = [], h = arguments[c]; h;) g.unshift(h), h = h
            .parentNode;
        e.push(g);
...
m.dom.getOwnerDocument = function (a) {
    ...
    return a.nodeType == m.dom.NodeType.DOCUMENT ? a : a.ownerDocument || a
        .document
};
...
m.dom.getFrameContentWindow = function (a) {
    try {
        return a.contentWindow || (a.contentDocument ? m.dom.getWindow(a
...
m.dom.setTextContent = function (a, c) {
    ...
    if ("textContent" in a) a.textContent = c;
        ...
        for (; a.lastChild != a.firstChild;) a.removeChild(m.asserts.assert(
            a.lastChild));
...
m.dom.findElement = function (a, c) {
    for (a = m.dom.getChildrenReverse_(a); 0 < a.length;) {
        var d = a.pop();
        if (c(d)) return d;
        for (d = d.lastElementChild; d; d = d.previousElementSibling) a
            .push(d)
    }
    return null
};
m.dom.findElements = function (a, c) {
    ...
    for (a = m.dom.getChildrenReverse_(a); 0 < a.length;) {
        var e = a.pop();
        c(e) && d.push(e);
        for (e = e.lastElementChild; e; e = e.previousElementSibling) a
            .push(e)
    }
    return d
};
...
m.dom.isFocusable = function (a) {
    var c;
    return (c = m.dom.nativelySupportsFocus_(a) ? !a.disabled && (!m.dom
                .hasSpecifiedTabIndex_(a) || m.dom.isTabIndexFocusable_(a)
                ) : m.dom.isFocusableTabIndex(a)) && m.userAgent.IE ? m.dom
        .hasNonZeroBoundingRect_(a) : c
};
m.dom.hasSpecifiedTabIndex_ = function (a) {
    return m.userAgent.IE && !m.userAgent.isVersionOrHigher("9") ? (a = a
...
m.dom.nativelySupportsFocus_ = function (a) {
    return a.tagName == m.dom.TagName.A && a.hasAttribute("href") || a
        .tagName == m.dom.TagName.INPUT || a.tagName == m.dom.TagName
        .TEXTAREA || a.tagName == m.dom.TagName.SELECT || a.tagName == m.dom
        .TagName.BUTTON
};
m.dom.hasNonZeroBoundingRect_ = function (a) {
    a = "function" !== typeof a.getBoundingClientRect || m.userAgent.IE &&
...
m.dom.getTextContent = function (a) {
    if (m.dom.BrowserFeature.CAN_USE_INNER_TEXT && null !== a &&
        "innerText" in a) a = m.string.canonicalizeNewlines(a.innerText);
    else {
        var c = [];
...
m.dom.getTextContent_ = function (a, c, d) {
    if (!(a.nodeName in m.dom.TAGS_TO_IGNORE_))
        if (a.nodeType == m.dom.NodeType.TEXT) d ? c.push(String(a
            .nodeValue).replace(/(\r\n|\r|\n)/g, "")) : c.push(a
            .nodeValue);
        else if (a.nodeName in m.dom.PREDEFINED_TAG_VALUES_) c.push(m.dom
        .PREDEFINED_TAG_VALUES_[a.nodeName]);
    else
        for (a = a.firstChild; a;) m.dom.getTextContent_(a, c, d), a = a
            .nextSibling
};
...
m.dom.getNodeTextOffset = function (a, c) {
    ...
    for (var d = []; a && a != c;) {
        for (var e = a; e = e.previousSibling;) d.unshift(m.dom
            .getTextContent(e));
        a = a.parentNode
    }
        ...
        if (f = a.pop(), !(f.nodeName in m.dom.TAGS_TO_IGNORE_))
            if (f.nodeType == m.dom.NodeType.TEXT) {
                var g = f.nodeValue.replace(/(\r\n|\r|\n)/g, "").replace(
                    / +/g, " ");
                e += g.length
            } else if (f.nodeName in m.dom.PREDEFINED_TAG_VALUES_) e += m
        .dom.PREDEFINED_TAG_VALUES_[f.nodeName].length;
    else
        for (g = f.childNodes.length - 1; 0 <= g; g--) a.push(f.childNodes[
            g]);
    m.isObject(d) && (d.remainder = f ? f.nodeValue.length + c - e - 1 : 0,
        d.node = f);
    return f
};
m.dom.isNodeList = function (a) {
    if (a && "number" == typeof a.length) {
        if (m.isObject(a)) return "function" == typeof a.item || "string" ==
            typeof a.item;
...
m.dom.getAncestorByTagNameAndClass = function (a, c, d, e) {
    ...
    return m.dom.getAncestor(a, function (g) {
        return (!f || g.nodeName == f) && (!d || "string" ===
            typeof g.className && y(g.className.split(/\s+/), d)
            )
    }, !0, e)
};
...
m.dom.getPixelRatio = function () {
    ...
    return void 0 !== a.devicePixelRatio ? a.devicePixelRatio : a
        .matchMedia ? m.dom.matchesPixelRatio_(3) || m.dom
        .matchesPixelRatio_(2) || m.dom.matchesPixelRatio_(1.5) || m.dom
        .matchesPixelRatio_(1) || .75 : 1
};
m.dom.matchesPixelRatio_ = function (a) {
    return m.dom.getWindow().matchMedia("(min-resolution: " + a +
...
var T = function () {
    this.isFinishedLaunch_ = this.retrieveJwtFailed_ = this
        .transactionStarted_ = this.walletIsLoaded_ = !1;
...
T.prototype.pollOnlineStatus = function () {
    if (!window.iapParams_.oauthToken) return chrome.i18n.getMessage(
        "please_sign_in");
    if (this.retrieveJwtFailed_) return chrome.i18n.getMessage(
        "jwt_retrieve_failed")
};
...
var Za = function (a) {
    ...
    a.isFinishedLaunch_ && c.oauthToken && a.walletIsLoaded_ && !a
        .transactionStarted_ && (a.transactionStarted_ = !0, m.dom
            .getDocument().querySelector("webview").contentWindow
            .postMessage({
                jwt: window.iapJwt_,
                parameters: c
            }, "*"))
...
T.prototype.onWindowReady = function () {
    ...
    if (a) {
            ...
            f = function (g) {
                if (window.sku_) {
                    ...
                    if ("env" in p) {
                        ...
                        n.baseUrlAndPath_ = n.baseUrl_ + S
                            .WEB_STORE_REQUEST_PATH_
                    }
                    e.retrieveJwtFailed_ = !1;
                    e.isFinishedLaunch_ = !1;
                    Ya(e.webStoreService_,
                        l.applicationId, h, m.bind(e
                            .retrieveJwtOnSuccess_, e), m.bind(e
                            .retrieveJwtOnFailed_, e), g, l.gl, l
                        .projection)
                } else e.isFinishedLaunch_ = !0, Za(e)
            };
        d.oauthToken ? f(d.oauthToken) : chrome.identity.getAuthToken({
            interactive: !0
        }, function (g) {
            window.iapParams_.oauthToken = g;
            f(g)
        });
        a.addEventListener("contentload", function () {
            if (!c) {
                c = !0;
        ...
        a.addEventListener("consolemessage", function (g) {
            -1 != g.message.indexOf("finished") && (e
                .walletIsLoaded_ = !0, Za(e))
        });
        a.addEventListener("newwindow", function (g) {
...
window.addEventListener("message", function (a) {
    console.log("event", a);
    if ("type" in a.data) window.purchase_result = a.data.result, window
        .close();
...
m.async.nextTick = function (a, c, d) {
    ...
    "function" === typeof m.global.setImmediate && (d || m.async.nextTick
        .useSetImmediate_()) ? m.global.setImmediate(e) : (m.async
        .nextTick.setImmediate_ || (m.async.nextTick.setImmediate_ = m
            .async.nextTick.getSetImmediateEmulator_()), m.async
        .nextTick.setImmediate_(e))
};
m.async.nextTick.useSetImmediate_ = function () {
    return m.global.Window && m.global.Window.prototype && !m.labs.userAgent
        .browser.isEdge() && m.global.Window.prototype.setImmediate == m
...
m.async.nextTick.getSetImmediateEmulator_ = function () {
    ...
    "undefined" === typeof a && "undefined" !== typeof window && window
        .postMessage && window.addEventListener && !m.labs.userAgent.engine
        .isPresto() && (a = function () {
            ...
            var h = "callImmediate" + Math.random(),
                l = "file:" == g.location.protocol ? "*" : g.location
                .protocol + "//" + g.location.host;
            f = m.bind(function (n) {
...
U.prototype.add = function (a, c) {
    ...
    d.set(a, c);
    this.workTail_ ? this.workTail_.next = d : ((0, m.asserts.assert)(!this
        .workHead_), this.workHead_ = d);
    this.workTail_ = d
};
...
U.freelist_ = new m.async.FreeList(function () {
    return new ab
}, function (a) {
    return a.reset()
...
m.DEBUG && (m.async.run.resetQueue = function () {
    m.async.run.workQueueScheduled_ = !1;
    m.async.run.workQueue_ = new U
});
...
m.json.parse = m.json.USE_NATIVE_JSON ? m.global.JSON.parse : function (a) {
    if (m.json.TRY_NATIVE_JSON) try {
        return m.global.JSON.parse(a)
    } catch (e) {
        var c = e
    }
    a = String(a);
    if (m.json.isValid(a)) try {
        var d = eval("(" + a + ")");
...
m.json.serialize = m.json.USE_NATIVE_JSON ? m.global.JSON.stringify : function (
    a, c) {
    ...
    if (null == c) d.push("null");
        ...
        if ("object" == typeof c) {
            if (Array.isArray(c)) {
                ...
                c = e.length;
                d.push("[");
                for (var f = "", g = 0; g < c; g++) d.push(f), f = e[g], bb(
                    a, a.replacer_ ? a.replacer_.call(e, String(g), f) :
                    f, d), f = ",";
                d.push("]");
                return
            }
            if (c instanceof String || c instanceof Number ||
                c instanceof Boolean) c = c.valueOf();
            else {
                d.push("{");
                g = "";
                for (e in c) Object.prototype.hasOwnProperty.call(c, e) && (
                    f = c[e], "function" != typeof f && (d.push(g), cb(
                        e, d), d.push(":"), bb(a, a.replacer_ ? a
                        .replacer_.call(c,
                            e, f) : f, d), g = ","));
                d.push("}");
                return
...
var cb = function (a, c) {
    c.push('"', a.replace(m.json.Serializer.charsToReplace_, function (d) {
        var e = m.json.Serializer.charToJsonCharCache_[d];
        e || (e = "\\u" + (d.charCodeAt(0) | 65536).toString(16)
            .substr(1), m.json.Serializer
            .charToJsonCharCache_[d] = e);
        return e
    }), '"')
};
m.json.hybrid = {};
m.json.hybrid.stringify = m.json.USE_NATIVE_JSON ? m.global.JSON.stringify :
    function (a) {
        if (m.global.JSON) try {
...
m.json.hybrid.parse = m.json.USE_NATIVE_JSON ? m.global.JSON.parse : function (
    a) {
...
m.log.Level.PREDEFINED_LEVELS = [m.log.Level.OFF, m.log.Level.SHOUT, m.log.Level
    .SEVERE, m.log.Level.WARNING, m.log.Level.INFO, m.log.Level.CONFIG, m
    .log.Level.FINE, m.log.Level.FINER, m.log.Level.FINEST, m.log.Level.ALL
];
...
m.log.Level.createPredefinedLevelsCache_ = function () {
    ...
    for (var a = 0, c; c = m.log.Level.PREDEFINED_LEVELS[a]; a++) m.log
        .Level.predefinedLevelsCache_[c.value] = c, m.log.Level
        .predefinedLevelsCache_[c.name] = c
};
m.log.Level.getPredefinedLevel = function (a) {
    m.log.Level.predefinedLevelsCache_ || m.log.Level
...
m.log.Level.getPredefinedLevelByValue = function (a) {
    m.log.Level.predefinedLevelsCache_ || m.log.Level
        .createPredefinedLevelsCache_();
    if (a in m.log.Level.predefinedLevelsCache_) return m.log.Level
...
m.log.LogBuffer.getInstance = function () {
    m.log.LogBuffer.instance_ || (m.log.LogBuffer.instance_ = new m.log
        .LogBuffer(m.log.LogBuffer.CAPACITY));
...
ib.prototype.publish = function (a) {
    for (var c = this; c;) c.handlers.forEach(function (d) {
        d(a)
    }), c = c.parent
};
...
m.log.LogRegistry.getInstance = function () {
    m.log.LogRegistry.instance_ || (m.log.LogRegistry.instance_ = new m.log
        .LogRegistry);
    return m.log.LogRegistry.instance_
};
m.log.getLogger = function () {
    return m.log.ENABLED ? V(m.log.LogRegistry.getInstance(),
        "goog.net.XhrIo", void 0).logger : null
};
m.log.getRootLogger = function () {
    return m.log.ENABLED ? V(m.log.LogRegistry.getInstance(), m.log
        .ROOT_LOGGER_NAME).logger : null
};
m.log.addHandler = function (a, c) {
    m.log.ENABLED && a && V(m.log.LogRegistry.getInstance(), a.getName())
        .handlers.push(c)
};
m.log.removeHandler = function (a, c) {
    return m.log.ENABLED && a && (a = V(m.log.LogRegistry.getInstance(), a
        .getName()), c = a.handlers.indexOf(c), -1 !== c) ? (a.handlers
        .splice(c, 1), !0) : !1
};
...
m.log.getEffectiveLevel = function (a) {
    return m.log.ENABLED && a ? V(m.log.LogRegistry.getInstance(), a
        .getName()).getEffectiveLevel() : m.log.Level.OFF
};
m.log.isLoggable = function (a, c) {
    return m.log.ENABLED && a && c ? c.value >= m.log.getEffectiveLevel(a)
        .value : !1
};
...
m.log.getLogRecord = function (a, c, d) {
    return gb(m.log.LogBuffer.getInstance(), c || m.log.Level.OFF, d, a
        .getName())
};
m.log.publishLogRecord = function (a, c) {
    m.log.ENABLED && a && m.log.isLoggable(a, c.getLevel()) && V(m.log
        .LogRegistry.getInstance(), a.getName()).publish(c)
};
...
m.net.XmlHttpFactory.prototype.getOptions = function () {
    var a;
    (a = this.cachedOptions_) || (a = {}, mb(this) && (a[m.net.XmlHttp
            .OptionType.USE_NULL_FUNCTION] = !0, a[m.net.XmlHttp
...
m.net.XmlHttp.setFactory = function (a, c) {
    m.net.XmlHttp.setGlobalFactory(new m.net.WrapperXmlHttpFactory(m.asserts
        .assert(a), m.asserts.assert(c)))
};
...
var mb = function (a) {
    if (m.net.XmlHttp.ASSUME_NATIVE_XHR || m.net.XmlHttpDefines
...
m.Promise = function (a, c) {
    ...
    this.executing_ = !1;
    0 < m.Promise.UNHANDLED_REJECTION_DELAY ? this.unhandledRejectionId_ =
        0 : 0 == m.Promise.UNHANDLED_REJECTION_DELAY && (this
            .hadUnhandledRejection_ = !1);
    m.Promise.LONG_STACK_TRACES && (this.stack_ = [], nb(this, Error(
        "created")), this.currentStep_ = 0);
    if (a != m.nullFunction) try {
        var d = this;
        a.call(c, function (e) {
            X(d, m.Promise.State_.FULFILLED, e)
        }, function (e) {
            if (m.DEBUG &&
                !(e instanceof m.Promise.CancellationError))
            try {
...
m.Promise.freelist_ = new m.async.FreeList(function () {
...
m.Promise.race = function (a) {
    return new m.Promise(function (c, d) {
        a.length || c(void 0);
        for (var e = 0, f; e < a.length; e++) f = a[e], m.Promise
            .resolveThen_(f, c, d)
    })
};
m.Promise.all = function (a) {
    return new m.Promise(function (c, d) {
        var e = a.length,
            f = [];
        if (e)
            for (var g = function (p, v) {
                    e--;
                    f[p] = v;
                    0 == e && c(f)
                }, h = function (p) {
                    d(p)
                }, l = 0, n; l < a.length; l++) n = a[l], m.Promise
                .resolveThen_(n, m.partial(g, l), h);
        else c(f)
    })
};
    ...
    return new m.Promise(function (c) {
        ...
        if (d)
            for (var f = function (l, n, p) {
                    ...
                    0 == d && c(e)
                }, g = 0, h; g < a.length; g++) h = a[g], m.Promise
                .resolveThen_(h, m.partial(f, g, !0), m.partial(f,
                    g, !1));
        else c(e)
    })
};
    ...
    return new m.Promise(function (c, d) {
        ...
        if (e)
            for (var g = function (p) {
                ...
                .resolveThen_(n, g, m.partial(h, l));
        else c(void 0)
    })
};
m.Promise.withResolver = function () {
    var a, c, d = new m.Promise(function (e, f) {
        a = e;
        c = f
    });
...
m.Promise.prototype.then = function (a, c, d) {
    null != a && m.asserts.assertFunction(a,
        "opt_onFulfilled should be a function.");
    null != c && m.asserts.assertFunction(c,
    ...
    return ob(this, "function" === typeof a ? a : null, "function" ===
        typeof c ? c : null, d)
};
...
var qb = function (a, c) {
        if (a.state_ == m.Promise.State_.PENDING)
            if (a.parent_) {
                ...
                if (d.callbackEntries_) {
                    for (var e = 0, f = null, g = null, h = d
                        .callbackEntries_; h && (h.always || (e++, h.child ==
                            a && (f = h), !(f && 1 < e))); h = h.next) f || (g =
                        h);
                    f && (d.state_ == m.Promise.State_.PENDING && 1 == e ? qb(d,
                        c) : (g ? (e = g, m.asserts.assert(d
                            .callbackEntries_), m.asserts.assert(
                            null != e), e.next == d
                        .callbackEntriesTail_ && (d
                            .callbackEntriesTail_ = e), e.next = e
                        .next.next) : rb(d), sb(d, f, m.Promise
                        .State_.REJECTED, c)))
                }
                a.parent_ = null
            } else X(a, m.Promise.State_.REJECTED,
                c)
    },
    ub = function (a, c) {
        a.callbackEntries_ || a.state_ != m.Promise.State_.FULFILLED && a
            .state_ != m.Promise.State_.REJECTED || tb(a);
        m.asserts.assert(null != c.onFulfilled);
        a.callbackEntriesTail_ ? a.callbackEntriesTail_.next = c : a
            .callbackEntries_ = c;
    ...
    ob = function (a, c, d, e) {
        ...
        f.child = new m.Promise(function (g, h) {
            ...
            f.onRejected = d ? function (l) {
                try {
                    var n = d.call(e, l);
                    void 0 === n &&
                        l instanceof m.Promise.CancellationError ?
                        h(l) : g(n)
                } catch (p) {
                    h(p)
                }
...
var X = function (a, c, d) {
    a.state_ == m.Promise.State_.PENDING && (a === d && (c = m.Promise
            .State_.REJECTED, d = new TypeError(
                "Promise cannot resolve to itself")), a.state_ = m
        .Promise.State_.BLOCKED, m.Promise.maybeThen_(d, a
            .unblockAndFulfill_, a.unblockAndReject_, a) || (a.result_ =
            d, a.state_ = c, a.parent_ = null, tb(a), c != m.Promise
            .State_.REJECTED || d instanceof m.Promise
            .CancellationError || m.Promise.addUnhandledRejection_(a, d)
            ))
};
m.Promise.maybeThen_ = function (a, c, d, e) {
    if (a instanceof m.Promise) return null != c && m.asserts
        .assertFunction(c, "opt_onFulfilled should be a function."),
        null != d && m.asserts.assertFunction(d,
            "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"
            ), m.Promise.LONG_STACK_TRACES && nb(a, Error("then")), ub(
            a, m.Promise.getCallbackEntry_(c || m.nullFunction, d ||
                null, e)), !0;
    if (m.Thenable.isImplementedBy(a)) return a.then(c, d, e), !0;
    if (m.isObject(a)) try {
        var f = a.then;
        if ("function" === typeof f) return m.Promise.tryThen_(a, f, c,
            d, e), !0
    } catch (g) {
        return d.call(e, g), !0
    }
...
var tb = function (a) {
    ...
    rb = function (a) {
        var c = null;
        a.callbackEntries_ && (c = a.callbackEntries_, a.callbackEntries_ = c
            .next, c.next = null);
...
m.Promise.prototype.executeCallbacks_ = function () {
    for (var a; a = rb(this);) m.Promise.LONG_STACK_TRACES && this
        .currentStep_++, sb(this, a, this.state_, this.result_);
    this.executing_ = !1
};
var sb = function (a, c, d, e) {
    if (d == m.Promise.State_.REJECTED && c.onRejected && !c.always)
        if (0 < m.Promise.UNHANDLED_REJECTION_DELAY)
            for (; a && a.unhandledRejectionId_; a = a.parent_) m.global
    ...
    if (c.child) c.child.parent_ = null, m.Promise.invokeCallback_(c, d, e);
        ...
        c.always ? c.onFulfilled.call(c.context) : m.Promise
            .invokeCallback_(c,
                d, e)
    } catch (f) {
...
m.Promise.invokeCallback_ = function (a, c, d) {
    c == m.Promise.State_.FULFILLED ? a.onFulfilled.call(a.context, d) : a
        .onRejected && a.onRejected.call(a.context, d)
};
var nb = function (a, c) {
    ...
    vb = function (a, c) {
        if (m.Promise.LONG_STACK_TRACES && c && "string" === typeof c.stack && a
            .stack_.length) {
            for (var d = ["Promise trace:"], e = a; e; e = e.parent_) {
                for (var f = a.currentStep_; 0 <= f; f--) d.push(e.stack_[f]);
                d.push("Value: [" + (e.state_ == m.Promise.State_.REJECTED ?
                    "REJECTED" : "FULFILLED") + "] <" + String(e
                    .result_) + ">")
            }
            c.stack += "\n\n" + d.join("\n")
        }
...
m.Promise.addUnhandledRejection_ = function (a, c) {
    0 < m.Promise.UNHANDLED_REJECTION_DELAY ? a.unhandledRejectionId_ = m
        .global.setTimeout(function () {
            vb(a, c);
            m.Promise.handleRejection_.call(null, c)
        }, m.Promise.UNHANDLED_REJECTION_DELAY) : 0 == m.Promise
        .UNHANDLED_REJECTION_DELAY && (a.hadUnhandledRejection_ = !0, m
            .async.run(function () {
                a.hadUnhandledRejection_ && (vb(a, c), m.Promise
                    .handleRejection_.call(null, c))
            }))
};
...
b.start = function () {
    ...
    this.timer_ || (this.timer_ = this.timerObject_.setTimeout(this
        .boundTick_, this.interval_), this.last_ = m.now())
};
b.stop = function () {
    this.enabled = !1;
...
m.Timer.callOnce = function (a, c, d) {
    ...
    else if (a && "function" == typeof a.handleEvent) a = m.bind(a
        .handleEvent, a);
    else throw Error("Invalid listener argument");
    return Number(c) > m.Timer.MAX_TIMEOUT_ ? m.Timer.INVALID_TIMEOUT_ID_ :
...
m.Timer.promise = function (a, c) {
    var d = null;
    return pb(new m.Promise(function (e, f) {
        d = m.Timer.callOnce(function () {
            e(c)
        }, a);
        d == m.Timer.INVALID_TIMEOUT_ID_ && f(Error(
...
m.net.XhrIo.protectEntryPoints = function (a) {
    m.net.XhrIo.prototype.onReadyStateChangeEntryPoint_ = a
        .protectEntryPoint(m.net.XhrIo.prototype
...
m.net.XhrIo.prototype.send = function (a, c, d, e) {
    ...
    .createInstance() : m.net.XmlHttp();
    this.xhrOptions_ = this.xmlHttpFactory_ ? this.xmlHttpFactory_
        .getOptions() : m.net.XmlHttp.getOptions();
    this.xhr_.onreadystatechange = m.bind(this.onReadyStateChange_,
        this);
    this.progressEventsEnabled_ && "onprogress" in this.xhr_ && (this.xhr_
        .onprogress = m.bind(function (g) {
            this.onProgressHandler_(g, !0)
        }, this), this.xhr_.upload && (this.xhr_.upload.onprogress = m
            .bind(this.onProgressHandler_, this)));
    try {
        m.log.fine(this.logger_, Y(this, "Opening Xhr")), this.inOpen_ = !0,
            this.xhr_.open(c, String(a), !0), this.inOpen_ = !1
    } catch (g) {
        m.log.fine(this.logger_, Y(this, "Error opening Xhr: " + g
        .message));
        wb(this, g);
        return
    }
    ...
    e && m.structs.forEach(e, function (g, h) {
        f.set(h,
            g)
    });
    e = ja(f.getKeys(), m.net.XhrIo.isContentTypeHeader_);
    d = m.global.FormData && a instanceof m.global.FormData;
    !y(m.net.XhrIo.METHODS_WITH_FORM_DATA, c) || e || d || f.set(m.net.XhrIo
        .CONTENT_TYPE_HEADER, m.net.XhrIo.FORM_CONTENT_TYPE);
    ...
    "withCredentials" in this.xhr_ && this.xhr_.withCredentials !== this
        .withCredentials_ && (this.xhr_.withCredentials = this
            .withCredentials_);
    try {
        xb(this), 0 < this.timeoutInterval_ &&
            (this.useXhr2Timeout_ = m.net.XhrIo.shouldUseXhr2Timeout_(this
                    .xhr_), m.log.fine(this.logger_, Y(this,
                    "Will abort after " + this.timeoutInterval_ +
                    "ms if incomplete, xhr2 " + this.useXhr2Timeout_)), this
                .useXhr2Timeout_ ? (this.xhr_[m.net.XhrIo.XHR2_TIMEOUT_] =
                    this.timeoutInterval_, this.xhr_[m.net.XhrIo
                        .XHR2_ON_TIMEOUT_] = m.bind(this.timeout_, this)) :
                this.timeoutId_ = m.Timer.callOnce(this.timeout_, this
                    .timeoutInterval_, this)), m.log.fine(this.logger_, Y(
                this, "Sending request")), this.inSend_ = !0, this.xhr_
            .send(a), this.inSend_ = !1
    } catch (g) {
        m.log.fine(this.logger_, Y(this, "Send error: " + g.message)), wb(
            this, g)
    }
};
m.net.XhrIo.shouldUseXhr2Timeout_ = function (a) {
    return m.userAgent.IE && m.userAgent.isVersionOrHigher(9) &&
        "number" === typeof a[m.net.XhrIo.XHR2_TIMEOUT_] && void 0 !== a[m
            .net.XhrIo.XHR2_ON_TIMEOUT_]
};
m.net.XhrIo.isContentTypeHeader_ = function (a) {
    return m.string.caseInsensitiveEquals(m.net.XhrIo.CONTENT_TYPE_HEADER,
        a)
};
m.net.XhrIo.prototype.timeout_ = function () {
    "undefined" != typeof m && this.xhr_ && (this.lastError_ =
        "Timed out after " + this.timeoutInterval_ + "ms, aborting", m
        .log.fine(this.logger_, Y(this, this.lastError_)), this
        .dispatchEvent(m.net.EventType.TIMEOUT), this.abort(m.net
            .ErrorCode.TIMEOUT))
};
var wb = function (a, c) {
        a.active_ = !1;
    ...
    yb = function (a) {
        a.errorDispatched_ || (a.errorDispatched_ = !0, a.dispatchEvent(m.net
                .EventType.COMPLETE), a.dispatchEvent(m.net.EventType
            .ERROR))
    };
m.net.XhrIo.prototype.abort = function () {
    this.xhr_ && this.active_ && (m.log.fine(this.logger_, Y(this,
            "Aborting")), this.active_ = !1, this.inAbort_ = !0, this
        .xhr_.abort(), this.inAbort_ = !1, this.dispatchEvent(m.net
            .EventType.COMPLETE), this.dispatchEvent(m.net.EventType
            .ABORT), zb(this))
};
m.net.XhrIo.prototype.disposeInternal = function () {
    this.xhr_ && (this.active_ && (this.active_ = !1, this.inAbort_ = !0,
        this.xhr_.abort(), this.inAbort_ = !1), zb(this, !0));
...
var Ab = function (a) {
    if (a.active_ && "undefined" != typeof m)
        if (a.xhrOptions_[m.net.XmlHttp.OptionType.LOCAL_REQUEST_ERROR] &&
            Bb(a) == m.net.XmlHttp.ReadyState.COMPLETE && 2 == Cb(a)) m.log
            .fine(a.logger_, Y(a,
                "Local request error detected and ignored"));
        else if (a.inSend_ && Bb(a) == m.net.XmlHttp.ReadyState.COMPLETE) m
        ...
        a.active_ = !1;
        try {
            if (a.isSuccess()) a.dispatchEvent(m.net.EventType.COMPLETE),
                a.dispatchEvent(m.net.EventType.SUCCESS);
            else {
                try {
                    var c = Bb(a) > m.net.XmlHttp.ReadyState.LOADED ? a.xhr_
                        .statusText : ""
                } catch (d) {
                    m.log.fine(a.logger_, "Can not get status: " + d
                        .message), c = ""
                }
                a.lastError_ = c + " [" + Cb(a) + "]";
                yb(a)
...
m.net.XhrIo.prototype.onProgressHandler_ = function (a, c) {
    m.asserts.assert(a.type === m.net.EventType.PROGRESS,
        "goog.net.EventType.PROGRESS is of the same type as raw XHR progress."
        );
    this.dispatchEvent(m.net.XhrIo.buildProgressEvent_(a, m.net.EventType
        .PROGRESS));
    this.dispatchEvent(m.net.XhrIo.buildProgressEvent_(a, c ? m.net
        .EventType.DOWNLOAD_PROGRESS : m.net.EventType
        .UPLOAD_PROGRESS))
};
...
var zb = function (a, c) {
        if (a.xhr_) {
            ...
            try {
                ...
                m.log.error(a.logger_,
                    "Problem encountered resetting onreadystatechange: " + f
                    .message)
            }
        }
    },
    xb = function (a) {
        a.xhr_ && a.useXhr2Timeout_ && (a.xhr_[m.net.XhrIo.XHR2_ON_TIMEOUT_] =
            null);
        a.timeoutId_ && (m.Timer.clear(a.timeoutId_), a.timeoutId_ = null)
    },
    Db = function (a) {
        return Bb(a) ==
            m.net.XmlHttp.ReadyState.COMPLETE
    };
m.net.XhrIo.prototype.isSuccess = function () {
    var a = Cb(this),
        c;
    if (!(c = m.net.HttpStatus.isSuccess(a))) {
        if (a = 0 === a) a = m.uri.utils.getEffectiveScheme(String(this
            .lastUri_)), a = !m.net.XhrIo.HTTP_SCHEME_PATTERN.test(a);
        c = a
    }
    return c
};
var Bb = function (a) {
        return a.xhr_ ? a.xhr_.readyState : m.net.XmlHttp.ReadyState
            .UNINITIALIZED
    },
    Cb = function (a) {
        try {
...
m.net.XhrIo.prototype.getResponseHeader = function (a) {
    if (this.xhr_ && Db(this)) return a = this.xhr_.getResponseHeader(a),
        null === a ? void 0 : a
};
...
m.debug.entryPointRegistry.register(function (a) {
    m.net.XhrIo.prototype.onReadyStateChangeEntryPoint_ = a(m.net.XhrIo
...
Z.prototype.onAuthTokenReceived_ = function (a) {
    if (void 0 === a) this.authFailedCallback_();
        ...
        var c = m.bind(this.onUberAuthResponse_, this),
            ...
            f = m.bind(function () {
                0 === this.uberTokenAttempts_ ? (++this
                        .uberTokenAttempts_, chrome.identity
                        .removeCachedAuthToken({
                            token: a
                        }, m.bind(this.authenticate, this))) : this
                    .authFailedCallback_()
            }, this);
        m.net.XhrIo.send(Z.UBERAUTH_URL_, function () {
            if (this.isSuccess()) {
                try {
                    var g =
                        this.xhr_ ? this.xhr_.responseText : ""
                } catch (h) {
                    m.log.fine(this.logger_,
                        "Can not get responseText: " + h.message
                        ), g = ""
                }
                c(g)
            } else f()
...
var J = function (a) {
    this.config_ = a;
    this.authenticator_ = new Z(a.getUrl(), m.bind(this.navigateToUrl_,
        this), m.bind(this.showOfflineWarning, this));
    ...
    this.webview_.addEventListener("contentload", m.bind(this
        .onContentLoad_, this), !1);
    this.webview_.addEventListener("newwindow",
        m.bind(this.onNewWindow_, this), !1);
...
var Fb = function (a) {
    a.hasLaunched_ = !1;
    a.config_.getUseAuth() ? a.authenticator_.authenticate() : a
        .navigateToUrl_(a.config_.getUrl())
};
b = J.prototype;
...
b.showOfflineWarning = function () {
    m.dom.getElement("app_unavailable").innerText = this.delegate_
        .getAppUnavailableMessage();
    m.dom.getElement("connect_to_network").innerText = this.customStatus_ ||
        chrome.i18n.getMessage("craw_connect_to_network");
...
b.setOnlineStatus_ = function (a) {
    ...
    a ? this.hasLaunched_ ? this.delegate_.finishedLaunch() && (this
        .offlineOverlay_.style.opacity = "0", this.offlineOverlay_.style
        .pointerEvents = "none", this.loadingOverlay_.style.opacity =
        "0", this.loadingOverlay_.style.pointerEvents = "none", m.Timer
        .callOnce(m.bind(this.hideVisibleOverlays_, this), 250)) : Fb(
        this) : this.showOfflineWarning()
};
b.pollOnlineStatus_ = function () {
    if (this.customStatus_ = this.delegate_.pollOnlineStatus()) this
        .setOnlineStatus_(!1);
    else {
...
J.NETWORK_TEST_URLS_ = ["https://www.google.com/images/cleardot.gif",
