...
def process_payload(payloads,url_path, abs_path, json_data):
...
def headless(extension_path,jsonf):
    ...
    data, popup = json_results(extension_path,jsonf)
    url_path, abs_path = get_ext_id(extension_path,popup)
